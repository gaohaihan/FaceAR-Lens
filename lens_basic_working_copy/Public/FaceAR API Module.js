 ...
 * // Instead, you should modify the "FaceAR API" script and access the functions through the imported class wrapper.
*/

/*
 * @param {RemoteApiResponse} response A raw API response from an FaceAR API
...
ApiModule.prototype.sensitivity = function(sensitivityVal, cb) {
    var req = global.RemoteApiRequest.create();
    req.endpoint = "sensitivity";
    var parameters = {};
    setParameter("sensitivityVal", sensitivityVal, parameters, false);
