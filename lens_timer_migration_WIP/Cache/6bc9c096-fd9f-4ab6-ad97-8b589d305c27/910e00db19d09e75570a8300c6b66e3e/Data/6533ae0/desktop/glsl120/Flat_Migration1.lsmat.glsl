...
//spec_const int opacityTexLayout 89 0
...
#if (sc_Voxelization)
{
l9_73=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_74;
#if (sc_OutputBounds)
{
float l9_75=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_74=vec4(l9_75,1.0-l9_75,1.0,1.0);
}
#else
{
vec4 l9_76;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_76=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_26)),l9_26);
}
#else
{
vec4 l9_77;
...
#endif
l9_77=vec4(l9_52.xyz*l9_78,l9_78);
}
#else
{
l9_77=l9_52;
