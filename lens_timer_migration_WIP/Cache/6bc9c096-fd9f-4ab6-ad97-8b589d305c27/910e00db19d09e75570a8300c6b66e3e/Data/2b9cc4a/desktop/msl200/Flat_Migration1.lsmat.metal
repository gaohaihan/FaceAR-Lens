...
float3 l9_91=l9_90;
float3 l9_92=l9_91;
float4 l9_93=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_92.xy,bias(l9_86));
float4 l9_94=l9_93;
if (l9_24)
{
l9_94=mix(l9_25,l9_94,float4(l9_28));
}
float4 l9_95=l9_94;
l9_9=l9_95;
float4 l9_96=l9_9;
...
{
float l9_99=l9_97.w;
float2 l9_100=tempGlobals.Surface_UVCoord1;
...
int l9_108=l9_103;
int l9_109=opacityTexLayout_tmp;
int l9_110=l9_108;
float2 l9_111=l9_101;
bool l9_112=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_113=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_114=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_115=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_116=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_117=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_118=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_119=0.0;
...
float4 l9_186=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_185.xy,bias(l9_179));
float4 l9_187=l9_186;
if (l9_117)
{
...
l9_102=l9_188;
float4 l9_189=l9_102;
l9_98=l9_99*l9_189.x;
}
else
{
l9_98=l9_97.w;
...
float l9_190=l9_98;
N0_Result=float4(l9_97.xyz,l9_190);
param_2=N0_Result;
Result_N0=param_2;
...
float4 l9_195=fast::max(param_5,float4(0.0));
float4 param_6=l9_195;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float4 l9_242=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_241.xy,bias(l9_235));
float4 l9_243=l9_242;
float4 l9_244=l9_243;
l9_206=l9_244;
}
float4 l9_245=l9_206;
float3 l9_246=l9_245.xyz;
float3 l9_247=l9_246;
float3 l9_248=l9_204.xyz;
float3 l9_249=definedBlend(l9_247,l9_248,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_205=float4(l9_249.x,l9_249.y,l9_249.z,l9_205.w);
float3 l9_250=mix(l9_246,l9_205.xyz,float3(l9_204.w));
l9_205=float4(l9_250.x,l9_250.y,l9_250.z,l9_205.w);
l9_205.w=1.0;
float4 l9_251=l9_205;
param_7=l9_251;
}
else
{
float4 l9_252=param_7;
