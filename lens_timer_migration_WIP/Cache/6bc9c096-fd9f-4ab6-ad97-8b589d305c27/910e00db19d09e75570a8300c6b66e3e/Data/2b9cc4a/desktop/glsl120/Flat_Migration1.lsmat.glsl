...
#endif
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_29=varPackedTex.z;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_30=l9_29;
float l9_31=varPackedTex.w;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
...
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),opacityTexLayout,l9_27);
vec4 l9_50=texture2D(opacityTex,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_51=mix(opacityTexBorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
vec4 l9_52=vec4(l9_0.xyz,l9_26);
...
{
l9_56=clamp(dot(l9_52.xyz,vec3(l9_26)),0.0,1.0);
}
#else
{
float l9_57;
...
{
l9_58=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*l9_26;
}
#else
{
float l9_59;
...
{
l9_59=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*l9_26;
}
#else
{
float l9_60;
...
{
l9_60=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_61;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_62=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_26;
}
#else
{
float l9_63;
...
{
l9_63=dot(l9_52.xyz,vec3(0.33333001))*l9_26;
}
#else
{
float l9_64;
...
#if (sc_FramebufferFetch)
{
l9_68=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_68=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_69,sc_ScreenTextureLayout,l9_70).xy,0.0);
}
#endif
vec3 l9_71=mix(l9_68.xyz,definedBlend(l9_68.xyz,l9_52.xyz).xyz,vec3(l9_26));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_73=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_26)),l9_26);
}
#else
{
vec4 l9_74;
...
#endif
l9_74=vec4(l9_52.xyz*l9_75,l9_75);
}
#else
{
l9_74=l9_52;
...
vec4 l9_78=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_76,vec4(0.0)));
vec4 l9_79=clamp(l9_78,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_80=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_80-0.0039215689)),min(1.0,l9_80+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_82=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_81).xy);
float l9_83=packValue(l9_82);
int l9_90=int(l9_79.w*255.0);
float l9_91=packValue(l9_90);
sc_writeFragData0Internal(vec4(packValue(l9_82),packValue(l9_82),packValue(l9_82),packValue(l9_82)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_83,packValue(l9_82),packValue(l9_82),packValue(l9_82)));
sc_writeFragData2(vec4(l9_91,packValue(l9_90),packValue(l9_90),packValue(l9_90)));
...
if (l9_99==0)
{
l9_102=texture2D(sc_OITAlpha0,l9_94);
l9_101=texture2D(sc_OITDepthLow0,l9_94);
l9_100=texture2D(sc_OITDepthHigh0,l9_94);
}
else
{
l9_102=vec4(0.0);
...
if (l9_99==1)
{
l9_105=texture2D(sc_OITAlpha1,l9_94);
l9_104=texture2D(sc_OITDepthLow1,l9_94);
l9_103=texture2D(sc_OITDepthHigh1,l9_94);
}
else
{
l9_105=l9_102;
...
if (any(notEqual(l9_103,vec4(0.0)))||any(notEqual(l9_104,vec4(0.0))))
{
int l9_106[8]=l9_95;
unpackValues(l9_103.w,l9_99,l9_106);
unpackValues(l9_103.z,l9_99,l9_106);
unpackValues(l9_103.y,l9_99,l9_106);
unpackValues(l9_103.x,l9_99,l9_106);
unpackValues(l9_104.w,l9_99,l9_106);
unpackValues(l9_104.z,l9_99,l9_106);
unpackValues(l9_104.y,l9_99,l9_106);
unpackValues(l9_104.x,l9_99,l9_106);
int l9_115[8]=l9_96;
unpackValues(l9_105.w,l9_99,l9_115);
unpackValues(l9_105.z,l9_99,l9_115);
unpackValues(l9_105.y,l9_99,l9_115);
unpackValues(l9_105.x,l9_99,l9_115);
}
l9_99++;
continue;
}
...
vec4 l9_120=texture2D(sc_OITFilteredDepthBoundsTexture,l9_94);
vec2 l9_121=l9_120.xy;
int l9_122;
#if (sc_SkinBonesCount>0)
{
l9_122=encodeDepth(((1.0-l9_120.x)*1000.0)+getDepthOrderingEpsilon(),l9_121);
}
#else
{
l9_122=0;
...
#endif
int l9_123=encodeDepth(viewSpaceDepth(),l9_121);
vec4 l9_124;
l9_124=l9_79*l9_79.w;
vec4 l9_125;
int l9_126=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_126<8)
{
int l9_127=l9_95[l9_126];
int l9_128=l9_123-l9_122;
bool l9_129=l9_127<l9_128;
bool l9_130;
if (l9_129)
{
l9_130=l9_95[l9_126]>0;
}
else
{
l9_130=l9_129;
...
if (l9_130)
{
vec3 l9_131=l9_124.xyz*(1.0-(float(l9_96[l9_126])/255.0));
l9_125=vec4(l9_131.x,l9_131.y,l9_131.z,l9_124.w);
}
else
{
l9_125=l9_124;
