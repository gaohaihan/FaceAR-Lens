...
//float4 Port_Input1_N001 4544
//float4 Port_Input1_N008 4560
//float depthRef 4576
//}
...
constant int SC_SOFTWARE_WRAP_MODE_U_opacityTex [[function_constant(77)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_opacityTex [[function_constant(80)]];
...
int l9_98=l9_93;
int l9_99=opacityTexLayout_tmp;
int l9_100=l9_98;
float2 l9_101=param_8.Surface_UVCoord0;
bool l9_102=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_103=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_104=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_105=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_106=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_107=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_108=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_109=0.0;
...
float4 l9_176=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_175.xy,bias(l9_169));
...
bool l9_182=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_182)
{
...
float4 l9_183=fast::max(param_10,float4(0.0));
float4 param_11=l9_183;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_186=fast::clamp(l9_185.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_186=fast::clamp(dot(l9_185.xyz,float3(l9_185.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_186=(1.0-dot(l9_185.xyz,float3(0.33333001)))*l9_185.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_186=(1.0-fast::clamp(dot(l9_185.xyz,float3(1.0)),0.0,1.0))*l9_185.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_186=fast::clamp(dot(l9_185.xyz,float3(1.0)),0.0,1.0)*l9_185.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_186=fast::clamp(dot(l9_185.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_186=dot(l9_185.xyz,float3(0.33333001))*l9_185.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_186=1.0-fast::clamp(dot(l9_185.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_187=l9_186;
float l9_188=l9_187;
float l9_189=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_188;
float3 l9_190=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_184.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_191=float4(l9_190.x,l9_190.y,l9_190.z,l9_189);
param_12=l9_191;
}
else
{
...
float4 l9_233=l9_194;
float3 l9_234=l9_233.xyz;
float3 l9_235=l9_234;
float3 l9_236=l9_192.xyz;
...
l9_193=float4(l9_237.x,l9_237.y,l9_237.z,l9_193.w);
float3 l9_238=mix(l9_234,l9_193.xyz,float3(l9_192.w));
l9_193=float4(l9_238.x,l9_238.y,l9_238.z,l9_193.w);
l9_193.w=1.0;
float4 l9_239=l9_193;
param_12=l9_239;
}
else
{
float4 l9_240=param_12;
float4 l9_241=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_241=float4(mix(float3(1.0),l9_240.xyz,float3(l9_240.w)),l9_240.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_242=l9_240.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_242=fast::clamp(l9_242,0.0,1.0);
}
l9_241=float4(l9_240.xyz*l9_242,l9_242);
}
else
{
l9_241=l9_240;
...
float4 l9_247=param_15;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_247.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_247;
return out;
}
} // FRAGMENT SHADER
