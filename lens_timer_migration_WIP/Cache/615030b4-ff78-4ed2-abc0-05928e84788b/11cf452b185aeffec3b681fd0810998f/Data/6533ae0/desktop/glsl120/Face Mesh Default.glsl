...
//sampler sampler Tweak_N2SmpSC 0:17
//sampler sampler baseTextureSmpSC 0:18
...
//texture texture2D Tweak_N2 0:0:0:17
//texture texture2D baseTexture 0:1:0:18
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTexture 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTexture 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 94 -1
//spec_const int Tweak_N2Layout 95 0
//spec_const int baseTextureLayout 96 0
//spec_const int intensityTextureLayout 97 0
//spec_const int sc_AmbientLightMode0 98 0
//spec_const int sc_AmbientLightMode1 99 0
//spec_const int sc_AmbientLightMode2 100 0
//spec_const int sc_AmbientLightMode_Constant 101 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 102 0
//spec_const int sc_AmbientLightMode_FromCamera 103 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 104 0
//spec_const int sc_AmbientLightsCount 105 0
//spec_const int sc_DepthBufferMode 106 0
//spec_const int sc_DirectionalLightsCount 107 0
//spec_const int sc_EnvLightMode 108 0
//spec_const int sc_EnvmapDiffuseLayout 109 0
//spec_const int sc_EnvmapSpecularLayout 110 0
//spec_const int sc_LightEstimationSGCount 111 0
//spec_const int sc_PointLightsCount 112 0
...
//spec_const int sc_StereoViewID 119 0
//SG_REFLECTION_END
...
#endif
float l9_28=clamp(l9_1.w,0.0,1.0);
...
#endif
vec3 l9_29=max(l9_1.xyz,vec3(0.0));
vec4 l9_30;
#if (sc_ProjectiveShadowsCaster)
{
l9_30=vec4(l9_29,l9_28);
}
#else
{
float l9_31=clamp(metallic,0.0,1.0);
float l9_32=clamp(roughness,0.0,1.0);
vec3 l9_33=ssSRGB_to_Linear(l9_29);
vec3 l9_34=normalize(l9_27);
vec3 l9_35=ssSRGB_to_Linear(Port_Emissive_N023);
vec3 l9_36;
#if (sc_SSAOEnabled)
{
l9_36=evaluateSSAO(varPos);
}
#else
{
l9_36=Port_AO_N023;
...
#endif
vec3 l9_37=vec3(l9_31);
vec3 l9_38=mix(vec3(0.039999999),l9_33*l9_31,l9_37);
vec3 l9_39=mix(l9_33*(1.0-l9_31),vec3(0.0),l9_37);
SurfaceProperties l9_40=SurfaceProperties(l9_39,l9_28,l9_34,varPos,l9_0,l9_31,l9_32,l9_35,l9_36,Port_SpecularAO_N023,vec3(1.0),l9_38);
vec4 l9_41=vec4(1.0);
vec3 l9_42;
vec3 l9_43;
vec3 l9_44;
...
l9_50=vec3(0.0);
l9_49=vec3(0.0);
LightingComponents l9_56;
LightProperties l9_57;
SurfaceProperties l9_58;
vec3 l9_59;
int l9_60=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_60<sc_DirectionalLightsCount)
{
LightingComponents l9_61=accumulateLight(LightingComponents(l9_49,l9_50,l9_55,l9_54,l9_52,l9_51),LightProperties(sc_DirectionalLights[l9_60].direction,sc_DirectionalLights[l9_60].color.xyz,sc_DirectionalLights[l9_60].color.w*l9_41[(l9_53<3) ? l9_53 : 3]),l9_40,l9_0);
l9_55=l9_61.indirectDiffuse;
l9_54=l9_61.indirectSpecular;
l9_53++;
l9_52=l9_61.emitted;
l9_51=l9_61.transmitted;
l9_50=l9_61.directSpecular;
l9_49=l9_61.directDiffuse;
l9_60++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_78<sc_PointLightsCount)
{
vec3 l9_80=sc_PointLights[l9_78].position-varPos;
vec3 l9_81=normalize(l9_80);
float l9_82=l9_41[(l9_79<3) ? l9_79 : 3];
float l9_83=clamp((dot(l9_81,sc_PointLights[l9_78].direction)*sc_PointLights[l9_78].angleScale)+sc_PointLights[l9_78].angleOffset,0.0,1.0);
float l9_84=(sc_PointLights[l9_78].color.w*l9_82)*(l9_83*l9_83);
float l9_85;
if (sc_PointLights[l9_78].falloffEnabled)
{
l9_85=l9_84*computeDistanceAttenuation(length(l9_80),sc_PointLights[l9_78].falloffEndDistance);
}
else
{
l9_85=l9_84;
...
l9_71=l9_79+1;
LightingComponents l9_86=accumulateLight(LightingComponents(l9_65,l9_66,l9_70,l9_69,l9_68,l9_67),LightProperties(l9_81,sc_PointLights[l9_78].color.xyz,l9_85),l9_40,l9_0);
l9_72=l9_86.directDiffuse;
l9_73=l9_86.directSpecular;
l9_74=l9_86.indirectDiffuse;
l9_75=l9_86.indirectSpecular;
l9_76=l9_86.emitted;
l9_77=l9_86.transmitted;
l9_70=l9_74;
l9_69=l9_75;
l9_79=l9_71;
l9_68=l9_76;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_90=abs(varShadowTex-vec2(0.5));
vec4 l9_91=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_90.x,l9_90.y),0.5);
l9_89=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_91.xyz,vec3(sc_ShadowColor.w)),vec3(l9_91.w*sc_ShadowDensity));
}
#else
{
l9_89=vec3(1.0);
...
{
vec2 l9_93=calcPanoramicTexCoordsFromDir(l9_34,sc_EnvmapRotation.y);
vec4 l9_94;
...
#if (SC_DEVICE_CLASS>=2)
{
l9_95=calcSeamlessPanoramicUvsForSampling(l9_93,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_95=l9_93;
...
#endif
l9_94=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_95,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#else
{
vec4 l9_96;
...
{
vec2 l9_97=calcSeamlessPanoramicUvsForSampling(l9_93,sc_EnvmapDiffuseSize.xy,0.0);
int l9_98;
...
#endif
l9_96=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_97,sc_EnvmapDiffuseLayout,l9_98).xy,-13.0);
}
#else
{
l9_96=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_93,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#endif
l9_94=l9_96;
}
#endif
l9_92=(l9_94.xyz*(1.0/l9_94.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_99;
...
float l9_102=l9_100.y;
float l9_103=l9_100.z;
l9_99=(((((((sc_Sh[8]*0.42904299)*((l9_101*l9_101)-(l9_102*l9_102)))+((sc_Sh[6]*0.74312502)*(l9_103*l9_103)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_101*l9_102))+(sc_Sh[7]*(l9_101*l9_103)))+(sc_Sh[5]*(l9_102*l9_103)))*0.85808599))+((((sc_Sh[3]*l9_101)+(sc_Sh[1]*l9_102))+(sc_Sh[2]*l9_103))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_99=vec3(0.0);
...
{
l9_105=l9_92+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_106=l9_92;
l9_106.x=l9_92.x+(1e-06*sc_AmbientLights[0].color.x);
l9_105=l9_106;
}
#endif
l9_104=l9_105;
...
{
l9_108=l9_104+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_109=l9_104;
l9_109.x=l9_104.x+(1e-06*sc_AmbientLights[1].color.x);
l9_108=l9_109;
}
#endif
l9_107=l9_108;
...
{
l9_111=l9_107+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_112=l9_107;
l9_112.x=l9_107.x+(1e-06*sc_AmbientLights[2].color.x);
l9_111=l9_112;
}
#endif
l9_110=l9_111;
...
{
vec3 l9_114;
l9_114=sc_LightEstimationData.ambientLight;
vec3 l9_115;
int l9_116=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_116<sc_LightEstimationSGCount)
{
float l9_117=dot(sc_LightEstimationData.sg[l9_116].axis,l9_34);
float l9_118=exp(-sc_LightEstimationData.sg[l9_116].sharpness);
float l9_119=l9_118*l9_118;
float l9_120=1.0/sc_LightEstimationData.sg[l9_116].sharpness;
float l9_121=(1.0+(2.0*l9_119))-l9_120;
float l9_122=sqrt(1.0-l9_121);
float l9_123=0.36000001*l9_117;
float l9_124=(1.0/(4.0*0.36000001))*l9_122;
float l9_125=l9_123+l9_124;
float l9_126;
if (step(abs(l9_123),l9_124)>0.5)
{
l9_126=(l9_125*l9_125)/l9_122;
}
else
{
l9_126=clamp(l9_117,0.0,1.0);
}
l9_115=l9_114+((((sc_LightEstimationData.sg[l9_116].color/vec3(sc_LightEstimationData.sg[l9_116].sharpness))*6.2831855)*((l9_121*l9_126)+(((l9_118-l9_119)*l9_120)-l9_119)))/vec3(3.1415927));
l9_114=l9_115;
l9_116++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_128=clamp(pow(l9_32,0.66666669),0.0,1.0)*5.0;
vec2 l9_129=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_34,reflect(-l9_0,l9_34),l9_32),sc_EnvmapRotation.y);
vec4 l9_130;
#if (SC_DEVICE_CLASS>=2)
{
float l9_131=floor(l9_128);
float l9_132=ceil(l9_128);
l9_130=mix(texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(calcSeamlessPanoramicUvsForSampling(l9_129,sc_EnvmapSpecularSize.xy,l9_131),sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_131),texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(calcSeamlessPanoramicUvsForSampling(l9_129,sc_EnvmapSpecularSize.xy,l9_132),sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_132),vec4(l9_128-l9_131));
}
#else
{
l9_130=texture2DLod(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_129,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,l9_128);
}
#endif
l9_127=vec3(0.0)+((((l9_130.xyz*(1.0/l9_130.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_40,abs(dot(l9_34,l9_0))));
}
#else
{
l9_127=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_134=clamp(l9_32*l9_32,0.0099999998,1.0);
vec3 l9_135;
l9_135=sc_LightEstimationData.ambientLight*l9_38;
int l9_136=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_136<sc_LightEstimationSGCount)
{
float l9_137=l9_134*l9_134;
vec3 l9_138=reflect(-l9_0,l9_34);
float l9_139=dot(l9_34,l9_0);
float l9_140=(2.0/l9_137)/(4.0*max(l9_139,9.9999997e-05));
float l9_141=length((l9_138*l9_140)+(sc_LightEstimationData.sg[l9_136].axis*sc_LightEstimationData.sg[l9_136].sharpness));
float l9_142=clamp(dot(l9_34,l9_138),0.0,1.0);
float l9_143=clamp(l9_139,0.0,1.0);
float l9_144=1.0-l9_137;
l9_135+=((((((((vec3(1.0/(3.1415927*l9_137))*exp((l9_141-l9_140)-sc_LightEstimationData.sg[l9_136].sharpness))*sc_LightEstimationData.sg[l9_136].color)*6.2831855)*(1.0-exp((-2.0)*l9_141)))/vec3(l9_141))*((1.0/(l9_142+sqrt(l9_137+((l9_144*l9_142)*l9_142))))*(1.0/(l9_143+sqrt(l9_137+((l9_144*l9_143)*l9_143))))))*(l9_38+((vec3(1.0)-l9_38)*pow(1.0-clamp(dot(l9_138,normalize(l9_138+l9_0)),0.0,1.0),5.0))))*l9_142);
l9_136++;
continue;
}
else
...
l9_148=vec3(0.0);
l9_147=vec3(0.0);
l9_146=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_39,vec3(l9_28));
l9_145=1.0;
}
#else
{
...
#endif
vec3 l9_150=l9_147*l9_36;
vec3 l9_151=l9_148+l9_150;
vec3 l9_152=l9_39*l9_151;
vec3 l9_153=l9_133*Port_SpecularAO_N023;
vec3 l9_154=l9_87+l9_153;
vec3 l9_155;
if (l9_149)
{
l9_155=l9_152*srgbToLinear(l9_145);
}
else
{
l9_155=l9_152;
}
vec3 l9_156=l9_155+l9_154;
vec3 l9_157=(l9_156+l9_35)+l9_146;
float l9_158=l9_157.x;
vec4 l9_159=vec4(l9_158,l9_157.yz,l9_145);
vec4 l9_160;
#if (sc_IsEditor)
{
vec4 l9_161=l9_159;
l9_161.x=l9_158+((l9_36.x*Port_SpecularAO_N023.x)*9.9999997e-06);
l9_160=l9_161;
}
#else
{
...
{
vec3 l9_163=l9_160.xyz*1.8;
vec3 l9_164=(l9_160.xyz*(l9_163+vec3(1.4)))/((l9_160.xyz*(l9_163+vec3(0.5)))+vec3(1.5));
l9_162=vec4(l9_164.x,l9_164.y,l9_164.z,l9_160.w);
}
#else
{
l9_162=l9_160;
...
#endif
vec3 l9_165=vec3(linearToSrgb(l9_162.x),linearToSrgb(l9_162.y),linearToSrgb(l9_162.z));
l9_30=vec4(l9_165.x,l9_165.y,l9_165.z,l9_162.w);
}
#endif
vec4 l9_166=max(l9_30,vec4(0.0));
float l9_167;
#if (Tweak_N12)
{
float l9_168;
...
{
l9_169=1-sc_GetStereoViewIndex();
}
#else
{
l9_169=sc_GetStereoViewIndex();
}
#endif
bool l9_170=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N2)!=0));
float l9_171=varPackedTex.x;
sc_SoftwareWrapEarly(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x);
float l9_172=l9_171;
float l9_173=varPackedTex.y;
sc_SoftwareWrapEarly(l9_173,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y);
float l9_174=l9_173;
vec2 l9_175;
float l9_176;
#if (SC_USE_UV_MIN_MAX_Tweak_N2)
{
bool l9_177;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_177=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x==3;
}
#else
{
l9_177=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_178=l9_172;
float l9_179=1.0;
sc_ClampUV(l9_178,Tweak_N2UvMinMax.x,Tweak_N2UvMinMax.z,l9_177,l9_179);
float l9_180=l9_178;
float l9_181=l9_179;
bool l9_182;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_182=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y==3;
}
#else
{
l9_182=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2)!=0);
}
#endif
float l9_183=l9_174;
float l9_184=l9_181;
sc_ClampUV(l9_183,Tweak_N2UvMinMax.y,Tweak_N2UvMinMax.w,l9_182,l9_184);
l9_176=l9_184;
...
#endif
vec2 l9_185=sc_TransformUV(l9_175,(int(SC_USE_UV_TRANSFORM_Tweak_N2)!=0),Tweak_N2Transform);
float l9_186=l9_185.x;
float l9_187=l9_176;
sc_SoftwareWrapLate(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).x,l9_170,l9_187);
float l9_188=l9_185.y;
float l9_189=l9_187;
sc_SoftwareWrapLate(l9_188,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2).y,l9_170,l9_189);
float l9_190=l9_189;
vec3 l9_191=sc_SamplingCoordsViewToGlobal(vec2(l9_186,l9_188),Tweak_N2Layout,l9_169);
vec4 l9_192=texture2D(Tweak_N2,l9_191.xy,0.0);
vec4 l9_193;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N2)
{
l9_193=mix(Tweak_N2BorderColor,l9_192,vec4(l9_190));
}
#else
{
l9_193=l9_192;
...
l9_168=(clamp((l9_193.x-(1.0-radius))+0.001,Port_Input1_N047+0.001,Port_Input2_N047+0.001)-0.001)/(l9_194+1.234e-06);
}
#else
{
l9_168=Port_Input2_N051;
}
#endif
l9_167=l9_168;
}
#else
{
l9_167=Port_Input2_N010;
}
#endif
float l9_195=l9_1.w*l9_167;
float l9_196=clamp(l9_195+0.001,Port_Input1_N001+0.001,Port_Input2_N001+0.001)-0.001;
vec4 l9_197=vec4(l9_166.x,l9_166.y,l9_166.z,vec4(0.0).w);
l9_197.w=l9_196;
vec4 l9_198;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_200=clamp(l9_196*2.0,0.0,1.0);
}
#else
{
float l9_201;
...
{
l9_201=clamp(dot(l9_197.xyz,vec3(l9_196)),0.0,1.0);
}
#else
{
float l9_202;
...
#if (sc_BlendMode_Multiply)
{
l9_203=(1.0-dot(l9_197.xyz,vec3(0.33333001)))*l9_196;
}
#else
{
float l9_204;
...
{
l9_204=(1.0-clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0))*l9_196;
}
#else
{
float l9_205;
#if (sc_BlendMode_ColoredGlass)
{
l9_205=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0)*l9_196;
}
#else
{
float l9_206;
#if (sc_BlendMode_Add)
{
l9_206=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_207;
...
{
l9_208=dot(l9_197.xyz,vec3(0.33333001))*l9_196;
}
#else
{
float l9_209;
#if (sc_BlendMode_Min)
{
l9_209=1.0-clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_210;
#if (sc_BlendMode_Max)
{
l9_210=clamp(dot(l9_197.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_210=1.0;
...
#endif
l9_198=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_197.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_199);
}
#else
{
vec4 l9_211;
...
{
vec3 l9_213=sc_GetFramebufferColor().xyz;
vec3 l9_214=mix(l9_213,definedBlend(l9_213,l9_197.xyz).xyz,vec3(l9_196));
...
#if (sc_Voxelization)
{
l9_216=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_217;
#if (sc_OutputBounds)
{
float l9_218=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_217=vec4(l9_218,1.0-l9_218,1.0,1.0);
}
#else
{
vec4 l9_219;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_219=vec4(mix(vec3(1.0),l9_197.xyz,vec3(l9_196)),l9_196);
}
#else
{
vec4 l9_220;
...
#endif
l9_220=vec4(l9_197.xyz*l9_221,l9_221);
}
#else
{
l9_220=l9_197;
...
vec4 l9_224=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_222,vec4(0.0)));
...
#endif
int l9_228=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_227).xy);
...
if (l9_245==0)
{
l9_248=texture2D(sc_OITAlpha0,l9_240);
l9_247=texture2D(sc_OITDepthLow0,l9_240);
l9_246=texture2D(sc_OITDepthHigh0,l9_240);
}
else
{
l9_248=vec4(0.0);
...
if (l9_245==1)
{
l9_251=texture2D(sc_OITAlpha1,l9_240);
l9_250=texture2D(sc_OITDepthLow1,l9_240);
l9_249=texture2D(sc_OITDepthHigh1,l9_240);
}
else
{
l9_251=l9_248;
...
vec4 l9_266=texture2D(sc_OITFilteredDepthBoundsTexture,l9_240);
