...
//float3x3 baseTextureTransform 4672
//float4 baseTextureUvMinMax 4720
//float4 baseTextureBorderColor 4736
//float4 baseColor 4752
//float metallic 4768
//float roughness 4772
//float3x3 Tweak_N2Transform 4832
//float4 Tweak_N2UvMinMax 4880
//float4 Tweak_N2BorderColor 4896
//float radius 4912
//float softness 4916
...
int l9_7=l9_2;
int l9_8=baseTextureLayout_tmp;
int l9_9=l9_7;
float2 l9_10=param_4.Surface_UVCoord0;
bool l9_11=(int(SC_USE_UV_TRANSFORM_baseTexture_tmp)!=0);
float3x3 l9_12=(*sc_set0.UserUniforms).baseTextureTransform;
int2 l9_13=int2(SC_SOFTWARE_WRAP_MODE_U_baseTexture_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTexture_tmp);
bool l9_14=(int(SC_USE_UV_MIN_MAX_baseTexture_tmp)!=0);
float4 l9_15=(*sc_set0.UserUniforms).baseTextureUvMinMax;
bool l9_16=(int(SC_USE_CLAMP_TO_BORDER_baseTexture_tmp)!=0);
float4 l9_17=(*sc_set0.UserUniforms).baseTextureBorderColor;
float l9_18=0.0;
...
float3 l9_83=l9_82;
float3 l9_84=l9_83;
float4 l9_85=sc_set0.baseTexture.sample(sc_set0.baseTextureSmpSC,l9_84.xy,bias(l9_78));
float4 l9_86=l9_85;
if (l9_16)
{
...
int l9_118=l9_113;
int l9_119=Tweak_N2Layout_tmp;
int l9_120=l9_118;
float2 l9_121=l9_110.Surface_UVCoord0;
bool l9_122=(int(SC_USE_UV_TRANSFORM_Tweak_N2_tmp)!=0);
float3x3 l9_123=(*sc_set0.UserUniforms).Tweak_N2Transform;
int2 l9_124=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N2_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N2_tmp);
bool l9_125=(int(SC_USE_UV_MIN_MAX_Tweak_N2_tmp)!=0);
float4 l9_126=(*sc_set0.UserUniforms).Tweak_N2UvMinMax;
bool l9_127=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N2_tmp)!=0);
float4 l9_128=(*sc_set0.UserUniforms).Tweak_N2BorderColor;
float l9_129=0.0;
...
float4 l9_196=sc_set0.Tweak_N2.sample(sc_set0.Tweak_N2SmpSC,l9_195.xy,bias(l9_189));
...
l9_207=l9_218;
float l9_225=0.0;
l9_225=l9_206/(l9_207+1.234e-06);
l9_108=l9_225;
l9_111=l9_108;
}
else
...
int l9_247=l9_246;
int l9_248=l9_247;
float3 l9_249=float3(l9_243,0.0);
int l9_250=l9_245;
int l9_251=l9_248;
if (l9_250==1)
{
l9_249.y=((2.0*l9_249.y)+float(l9_251))-1.0;
}
float2 l9_252=l9_249.xy;
l9_244=l9_252;
}
else
{
...
int l9_263=l9_258;
float2 l9_264=l9_256;
int l9_265=sc_ScreenTextureLayout_tmp;
int l9_266=l9_263;
float l9_267=l9_257;
...
float4 l9_274=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_273.xy,bias(l9_267));
float4 l9_275=l9_274;
float4 l9_276=l9_275;
l9_238=l9_276;
}
float4 l9_277=l9_238;
float3 l9_278=l9_277.xyz;
float3 l9_279=l9_278;
float3 l9_280=l9_236.xyz;
float3 l9_281=definedBlend(l9_279,l9_280,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_237=float4(l9_281.x,l9_281.y,l9_281.z,l9_237.w);
float3 l9_282=mix(l9_278,l9_237.xyz,float3(l9_236.w));
l9_237=float4(l9_282.x,l9_282.y,l9_282.z,l9_237.w);
l9_237.w=1.0;
float4 l9_283=l9_237;
param_22=l9_283;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_284=float4(in.varScreenPos.xyz,1.0);
param_22=l9_284;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_285=gl_FragCoord;
float l9_286=fast::clamp(abs(l9_285.z),0.0,1.0);
float4 l9_287=float4(l9_286,1.0-l9_286,1.0,1.0);
param_22=l9_287;
}
else
{
float4 l9_288=param_22;
float4 l9_289=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_289=float4(mix(float3(1.0),l9_288.xyz,float3(l9_288.w)),l9_288.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_290=l9_288.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_290=fast::clamp(l9_290,0.0,1.0);
}
l9_289=float4(l9_288.xyz*l9_290,l9_290);
}
else
{
l9_289=l9_288;
...
float4 l9_295=param_25;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_295.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_295;
return out;
}
} // FRAGMENT SHADER
