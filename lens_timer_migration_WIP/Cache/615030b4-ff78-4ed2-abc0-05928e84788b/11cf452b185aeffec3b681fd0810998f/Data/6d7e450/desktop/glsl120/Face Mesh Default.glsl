...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N2 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_baseTexture 34 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 35 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N2 36 0
//spec_const bool SC_USE_UV_MIN_MAX_baseTexture 37 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N2 39 0
//spec_const bool SC_USE_UV_TRANSFORM_baseTexture 40 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 41 0
//spec_const bool Tweak_N11 42 0
//spec_const bool Tweak_N12 43 0
//spec_const bool Tweak_N2HasSwappedViews 44 0
//spec_const bool Tweak_N69 45 0
//spec_const bool UseViewSpaceDepthVariant 46 1
//spec_const bool baseTextureHasSwappedViews 47 0
...
//spec_const bool sc_CanUseStandardDerivatives 65 0
...
//spec_const int SC_DEVICE_CLASS 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N2 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTexture 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N2 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTexture 99 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 100 -1
//spec_const int Tweak_N2Layout 101 0
//spec_const int baseTextureLayout 102 0
...
#endif
l9_94=sc_EnvmapSpecularSampleViewIndexBias(l9_95,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_96;
...
#else
{
l9_96=sc_EnvmapSpecularSampleViewIndexBias(l9_93,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_94=l9_96;
}
...
l9_130=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_129,sc_EnvmapSpecularSize.xy,l9_131),sc_EnvmapSpecularGetStereoViewIndex(),l9_131),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_129,sc_EnvmapSpecularSize.xy,l9_132),sc_EnvmapSpecularGetStereoViewIndex(),l9_132),vec4(l9_128-l9_131));
}
#else
{
l9_130=sc_EnvmapSpecularSampleViewIndexLevel(l9_129,sc_EnvmapSpecularGetStereoViewIndex(),l9_128);
}
#endif
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_216=vec4(mix(vec3(1.0),l9_197.xyz,vec3(l9_196)),l9_196);
}
#else
{
vec4 l9_217;
...
#endif
l9_217=vec4(l9_197.xyz*l9_218,l9_218);
}
#else
{
l9_217=l9_197;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_226).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_227=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_226).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_239).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_244==0)
{
l9_247=texture2D(sc_OITAlpha0,l9_239);
l9_246=texture2D(sc_OITDepthLow0,l9_239);
l9_245=texture2D(sc_OITDepthHigh0,l9_239);
}
else
{
l9_247=vec4(0.0);
...
if (l9_244==1)
{
l9_250=texture2D(sc_OITAlpha1,l9_239);
l9_249=texture2D(sc_OITDepthLow1,l9_239);
l9_248=texture2D(sc_OITDepthHigh1,l9_239);
}
else
{
l9_250=l9_247;
...
vec4 l9_265=texture2D(sc_OITFilteredDepthBoundsTexture,l9_239);
