...
//spec_const bool uv2EnableAnimation 89 0
//spec_const bool uv3EnableAnimation 90 0
//spec_const int NODE_13_DROPLIST_ITEM 91 0
//spec_const int NODE_27_DROPLIST_ITEM 92 0
//spec_const int NODE_38_DROPLIST_ITEM 93 0
//spec_const int NODE_49_DROPLIST_ITEM 94 0
//spec_const int NODE_69_DROPLIST_ITEM 95 0
//spec_const int NODE_76_DROPLIST_ITEM 96 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 99 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 100 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 101 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 103 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 104 -1
//spec_const int baseTexLayout 105 0
//spec_const int emissiveTexLayout 106 0
//spec_const int intensityTextureLayout 107 0
//spec_const int opacityTexLayout 108 0
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_115=vec4(mix(vec3(1.0),l9_91.xyz,vec3(l9_59)),l9_59);
}
#else
{
vec4 l9_116;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_123=sc_ScreenCoordsGlobalToView(l9_0);
...
#endif
int l9_124=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_123).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_136=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_141==0)
{
l9_144=texture2D(sc_OITAlpha0,l9_136);
l9_143=texture2D(sc_OITDepthLow0,l9_136);
l9_142=texture2D(sc_OITDepthHigh0,l9_136);
}
else
{
l9_144=vec4(0.0);
...
if (l9_141==1)
{
l9_147=texture2D(sc_OITAlpha1,l9_136);
l9_146=texture2D(sc_OITDepthLow1,l9_136);
l9_145=texture2D(sc_OITDepthHigh1,l9_136);
}
else
{
l9_147=l9_144;
...
vec4 l9_162=texture2D(sc_OITFilteredDepthBoundsTexture,l9_136);
