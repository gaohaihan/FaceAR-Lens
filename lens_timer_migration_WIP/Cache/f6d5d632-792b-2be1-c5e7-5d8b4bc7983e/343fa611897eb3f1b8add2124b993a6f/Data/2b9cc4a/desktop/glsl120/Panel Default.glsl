...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_61=vec4(mix(vec3(1.0),l9_39.xyz,vec3(l9_40)),l9_40);
}
#else
{
vec4 l9_62;
...
#endif
l9_62=vec4(l9_39.xyz*l9_63,l9_63);
}
#else
{
l9_62=l9_39;
...
vec4 l9_66=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_64,vec4(0.0)));
