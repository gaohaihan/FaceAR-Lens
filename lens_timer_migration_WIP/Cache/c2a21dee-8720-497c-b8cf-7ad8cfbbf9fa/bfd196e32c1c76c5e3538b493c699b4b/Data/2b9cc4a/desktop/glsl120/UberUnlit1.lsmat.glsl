...
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),varPackedTex.xy,varPackedTex.zw,varColor,sc_ScreenCoordsGlobalToView(l9_0));
...
#if (ENABLE_BASE_TEX)
{
vec2 l9_2=N7_getUV(NODE_27_DROPLIST_ITEM);
int l9_3;
...
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),baseTexLayout,l9_3);
...
#if (ENABLE_RECOLOR)
{
vec3 l9_29=((recolorRed*l9_1.x)+(recolorGreen*l9_1.y))+(recolorBlue*l9_1.z);
l9_28=vec4(l9_29.x,l9_29.y,l9_29.z,l9_1.w);
}
#else
{
l9_28=l9_1;
...
{
vec2 l9_31=N7_getUV(NODE_69_DROPLIST_ITEM);
int l9_32;
...
#endif
bool l9_33=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_34=l9_31.x;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_35=l9_34;
float l9_36=l9_31.y;
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_37=l9_36;
vec2 l9_38;
float l9_39;
...
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_41=l9_35;
float l9_42=1.0;
sc_ClampUV(l9_41,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_40,l9_42);
float l9_43=l9_41;
float l9_44=l9_42;
bool l9_45;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_46=l9_37;
float l9_47=l9_44;
sc_ClampUV(l9_46,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_45,l9_47);
l9_39=l9_47;
...
#endif
vec2 l9_48=sc_TransformUV(l9_38,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_33,l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_33,l9_52);
float l9_53=l9_52;
vec3 l9_54=sc_SamplingCoordsViewToGlobal(vec2(l9_49,l9_51),opacityTexLayout,l9_32);
vec4 l9_55=texture2D(opacityTex,l9_54.xy,0.0);
vec4 l9_56;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_56=mix(opacityTexBorderColor,l9_55,vec4(l9_53));
}
#else
{
l9_56=l9_55;
...
#endif
float l9_57=l9_30*l9_28.w;
vec4 l9_58;
float l9_59;
if (NODE_38_DROPLIST_ITEM==1)
{
l9_59=l9_57*tempGlobals.VertexColor.w;
l9_58=l9_28*tempGlobals.VertexColor;
}
else
{
l9_59=l9_57;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_61=N7_getUV(NODE_76_DROPLIST_ITEM);
int l9_62;
...
#endif
bool l9_63=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_64=l9_61.x;
...
float l9_79=l9_78.x;
float l9_80=l9_69;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_63,l9_80);
float l9_81=l9_78.y;
float l9_82=l9_80;
sc_SoftwareWrapLate(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_63,l9_82);
float l9_83=l9_82;
vec3 l9_84=sc_SamplingCoordsViewToGlobal(vec2(l9_79,l9_81),emissiveTexLayout,l9_62);
...
#endif
bool l9_87=NODE_38_DROPLIST_ITEM==2;
vec3 l9_88;
if (l9_87)
{
l9_88=l9_60+tempGlobals.VertexColor.xyz;
}
else
{
l9_88=l9_60;
...
vec3 l9_89;
if (l9_87||(int(ENABLE_EMISSIVE)!=0))
{
l9_89=ssPow((l9_88*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
else
{
l9_89=l9_88;
}
vec3 l9_90=l9_58.xyz+ssPow((l9_89+vec3(0.0))+vec3(0.0),vec3(0.45454547));
...
{
l9_95=clamp(dot(l9_91.xyz,vec3(l9_59)),0.0,1.0);
}
#else
{
float l9_96;
...
{
l9_97=(1.0-dot(l9_91.xyz,vec3(0.33333001)))*l9_59;
}
#else
{
float l9_98;
...
{
l9_98=(1.0-clamp(dot(l9_91.xyz,vec3(1.0)),0.0,1.0))*l9_59;
}
#else
{
float l9_99;
...
{
l9_99=clamp(dot(l9_91.xyz,vec3(1.0)),0.0,1.0)*l9_59;
}
#else
{
float l9_100;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_101=clamp(dot(l9_91.xyz,vec3(1.0)),0.0,1.0)*l9_59;
}
#else
{
float l9_102;
...
{
l9_102=dot(l9_91.xyz,vec3(0.33333001))*l9_59;
}
#else
{
float l9_103;
...
#endif
l9_107=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_108,sc_ScreenTextureLayout,l9_109).xy,0.0);
}
#endif
vec3 l9_110=mix(l9_107.xyz,definedBlend(l9_107.xyz,l9_91.xyz).xyz,vec3(l9_59));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_112=vec4(mix(vec3(1.0),l9_91.xyz,vec3(l9_59)),l9_59);
}
#else
{
vec4 l9_113;
...
#endif
l9_113=vec4(l9_91.xyz*l9_114,l9_114);
}
#else
{
l9_113=l9_91;
...
vec4 l9_117=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_115,vec4(0.0)));
vec4 l9_118=clamp(l9_117,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_119=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_119-0.0039215689)),min(1.0,l9_119+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_120=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_120).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_121=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_120).xy);
float l9_122=packValue(l9_121);
int l9_129=int(l9_118.w*255.0);
float l9_130=packValue(l9_129);
sc_writeFragData0Internal(vec4(packValue(l9_121),packValue(l9_121),packValue(l9_121),packValue(l9_121)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_122,packValue(l9_121),packValue(l9_121),packValue(l9_121)));
sc_writeFragData2(vec4(l9_130,packValue(l9_129),packValue(l9_129),packValue(l9_129)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_133=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_138==0)
{
l9_141=texture2D(sc_OITAlpha0,l9_133);
l9_140=texture2D(sc_OITDepthLow0,l9_133);
l9_139=texture2D(sc_OITDepthHigh0,l9_133);
}
else
{
l9_141=vec4(0.0);
...
if (l9_138==1)
{
l9_144=texture2D(sc_OITAlpha1,l9_133);
l9_143=texture2D(sc_OITDepthLow1,l9_133);
l9_142=texture2D(sc_OITDepthHigh1,l9_133);
}
else
{
l9_144=l9_141;
...
if (any(notEqual(l9_142,vec4(0.0)))||any(notEqual(l9_143,vec4(0.0))))
{
int l9_145[8]=l9_134;
unpackValues(l9_142.w,l9_138,l9_145);
unpackValues(l9_142.z,l9_138,l9_145);
unpackValues(l9_142.y,l9_138,l9_145);
unpackValues(l9_142.x,l9_138,l9_145);
unpackValues(l9_143.w,l9_138,l9_145);
unpackValues(l9_143.z,l9_138,l9_145);
unpackValues(l9_143.y,l9_138,l9_145);
unpackValues(l9_143.x,l9_138,l9_145);
int l9_154[8]=l9_135;
unpackValues(l9_144.w,l9_138,l9_154);
unpackValues(l9_144.z,l9_138,l9_154);
unpackValues(l9_144.y,l9_138,l9_154);
unpackValues(l9_144.x,l9_138,l9_154);
}
l9_138++;
continue;
}
...
vec4 l9_159=texture2D(sc_OITFilteredDepthBoundsTexture,l9_133);
vec2 l9_160=l9_159.xy;
int l9_161;
#if (sc_SkinBonesCount>0)
{
l9_161=encodeDepth(((1.0-l9_159.x)*1000.0)+getDepthOrderingEpsilon(),l9_160);
}
#else
{
l9_161=0;
...
#endif
int l9_162=encodeDepth(viewSpaceDepth(),l9_160);
vec4 l9_163;
l9_163=l9_118*l9_118.w;
vec4 l9_164;
int l9_165=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_165<8)
{
int l9_166=l9_134[l9_165];
int l9_167=l9_162-l9_161;
bool l9_168=l9_166<l9_167;
bool l9_169;
if (l9_168)
{
l9_169=l9_134[l9_165]>0;
}
else
{
l9_169=l9_168;
...
if (l9_169)
{
vec3 l9_170=l9_163.xyz*(1.0-(float(l9_135[l9_165])/255.0));
l9_164=vec4(l9_170.x,l9_170.y,l9_170.z,l9_163.w);
}
else
{
l9_164=l9_163;
...
sc_writeFragData0Internal(l9_118,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
