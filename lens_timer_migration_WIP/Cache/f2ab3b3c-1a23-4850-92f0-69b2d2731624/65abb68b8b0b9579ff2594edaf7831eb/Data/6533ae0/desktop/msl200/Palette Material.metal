...
//int paletteType 4512
//float brightness 4516
//float saturation 4520
//float4 colorEnd 4528
//float4 colorStart 4544
//float value 4560
//float4 baseColor 4576
//float Port_Input0_N047 4596
//float Port_Value_N040 4600
//float Port_Value_N043 4604
//float Port_Input0_N050 4612
//float Port_Value4_N211 4620
...
//float2 Port_Import_N064 4696
//float2 Port_Import_N066 4704
//float Port_Input1_N071 4712
//float Port_Input2_N071 4716
//float4 Port_Default_N038 4720
//float depthRef 4736
//}
...
float4 param_16=(*sc_set0.UserUniforms).Port_Default_N038;
ssGlobals param_18=Globals;
float l9_76=0.0;
float l9_77=float((*sc_set0.UserUniforms).paletteType);
l9_76=l9_77;
param_12=l9_76;
param_12=floor(param_12);
float4 param_17;
if (param_12==0.0)
{
float2 l9_78=float2(0.0);
l9_78=param_18.Surface_UVCoord0;
float l9_79=0.0;
l9_79=l9_78.y;
float l9_80=0.0;
l9_80=l9_79;
float l9_81=0.0;
float l9_82=(*sc_set0.UserUniforms).Port_Value_N040;
float l9_83=l9_82+0.001;
l9_83-=0.001;
l9_81=l9_83;
float l9_84=0.0;
float l9_85=(*sc_set0.UserUniforms).Port_Value_N043;
float l9_86=l9_85+0.001;
l9_86-=0.001;
l9_84=l9_86;
float l9_87=0.0;
l9_87=l9_81/l9_84;
...
l9_91=l9_90/l9_81;
float l9_92=0.0;
l9_92=float(l9_80>l9_91);
float l9_93=0.0;
l9_93=mix((*sc_set0.UserUniforms).Port_Input0_N047,l9_89,l9_92);
float l9_94=0.0;
float l9_95=(*sc_set0.UserUniforms).brightness;
l9_94=l9_95;
float l9_96=0.0;
l9_96=fast::clamp(l9_94,0.0,1.0);
float l9_97=0.0;
l9_97=l9_93*l9_96;
float l9_98=0.0;
l9_98=l9_84/l9_81;
...
l9_99=l9_80/l9_98;
float l9_100=0.0;
l9_100=float(l9_80<l9_98);
float l9_101=0.0;
l9_101=mix((*sc_set0.UserUniforms).Port_Input0_N050,l9_99,l9_100);
float l9_102=0.0;
float l9_103=(*sc_set0.UserUniforms).saturation;
l9_102=l9_103;
float l9_104=0.0;
l9_104=fast::clamp(l9_102,0.0,1.0);
float l9_105=0.0;
l9_105=l9_101*l9_104;
float4 l9_106=float4(0.0);
l9_106.x=l9_80;
l9_106.y=l9_97;
l9_106.z=l9_105;
l9_106.w=(*sc_set0.UserUniforms).Port_Value4_N211;
float4 l9_107=float4(0.0);
float3 l9_108=l9_106.xyz;
float3 l9_109=l9_108.zzz;
float l9_110=3.0*fract(l9_108.x+0.16666667);
float l9_111=2.0*fract(l9_110);
float l9_112=l9_108.y;
float l9_113=fast::clamp(l9_112,0.0,1.0);
float2 l9_114=l9_109.yz-((float2(1.0,l9_111)-float2(fast::max(0.0,l9_111-1.0)))*(l9_108.z*l9_113));
l9_109=float3(l9_109.x,l9_114.x,l9_114.y);
if (l9_110>=1.0)
{
l9_109=l9_109.zxy;
}
...
float3 l9_115=l9_109;
l9_107=float4(l9_115,l9_106.w);
...
float4 l9_118=(*sc_set0.UserUniforms).colorEnd;
l9_117=l9_118;
float4 l9_119=float4(0.0);
l9_119=l9_117;
float4 l9_120=float4(0.0);
float4 l9_121=(*sc_set0.UserUniforms).colorStart;
l9_120=l9_121;
float4 l9_122=float4(0.0);
l9_122=l9_120;
float2 l9_123=float2(0.0);
l9_123=param_18.Surface_UVCoord0;
float2 l9_124=float2(0.0);
l9_124=(((l9_123-float2((*sc_set0.UserUniforms).Port_RangeMinA_N061))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N061-(*sc_set0.UserUniforms).Port_RangeMinA_N061)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N061-(*sc_set0.UserUniforms).Port_RangeMinB_N061))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N061);
float2 l9_125=float2(0.0);
l9_125=(*sc_set0.UserUniforms).Port_Import_N062;
float2 l9_126=float2(0.0);
l9_126=((l9_124-(*sc_set0.UserUniforms).Port_Center_N063)*l9_125)+(*sc_set0.UserUniforms).Port_Center_N063;
float2 l9_127=float2(0.0);
l9_127=(*sc_set0.UserUniforms).Port_Import_N064;
float2 l9_128=float2(0.0);
l9_128=l9_126-l9_127;
float2 l9_129=float2(0.0);
l9_129=(*sc_set0.UserUniforms).Port_Import_N066;
float2 l9_130=float2(0.0);
l9_130=l9_129-l9_127;
float l9_131=0.0;
l9_131=dot(l9_128,l9_130);
float l9_132=0.0;
l9_132=dot(l9_130,l9_130);
float l9_133=0.0;
l9_133=l9_131/l9_132;
float l9_134=0.0;
l9_134=fast::clamp(l9_133+0.001,(*sc_set0.UserUniforms).Port_Input1_N071+0.001,(*sc_set0.UserUniforms).Port_Input2_N071+0.001)-0.001;
float l9_135=0.0;
l9_135=smoothstep((*sc_set0.UserUniforms).Port_Input0_N072,(*sc_set0.UserUniforms).Port_Input1_N072,l9_134);
float4 l9_136=float4(0.0);
l9_136=mix(l9_119,l9_122,float4(l9_135));
...
float4 l9_139=(*sc_set0.UserUniforms).colorStart;
l9_138=l9_139;
float4 l9_140=float4(0.0);
float4 l9_141=(*sc_set0.UserUniforms).colorEnd;
l9_140=l9_141;
float l9_142=0.0;
float l9_143=(*sc_set0.UserUniforms).value;
l9_142=l9_143;
float2 l9_144=float2(0.0);
l9_144=param_18.Surface_UVCoord0;
float l9_145=0.0;
l9_145=l9_144.y;
float l9_146=0.0;
l9_146=step(l9_142,l9_145);
float4 l9_147=float4(0.0);
l9_147=mix(l9_138,l9_140,float4(l9_146));
param_15=l9_147;
param_17=param_15;
}
else
...
float4 param_19=Result_N38;
float4 param_20=param_19;
bool l9_148=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_149;
if (l9_148)
{
l9_149=!PreviewInfo.Saved;
}
else
{
l9_149=l9_148;
...
if (l9_149)
{
l9_150=51==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_150=l9_149;
...
float4 l9_154=fast::max(param_23,float4(0.0));
float4 param_24=l9_154;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_166=out.FragColor0;
float4 l9_167=l9_166;
l9_165=l9_167;
}
else
{
float4 l9_168=gl_FragCoord;
float2 l9_169=l9_168.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_174=l9_173;
int l9_175=l9_174;
float3 l9_176=float3(l9_170,0.0);
int l9_177=l9_172;
int l9_178=l9_175;
if (l9_177==1)
{
l9_176.y=((2.0*l9_176.y)+float(l9_178))-1.0;
}
float2 l9_179=l9_176.xy;
l9_171=l9_179;
}
else
{
...
int l9_190=l9_185;
float2 l9_191=l9_183;
int l9_192=sc_ScreenTextureLayout_tmp;
int l9_193=l9_190;
float l9_194=l9_184;
...
float3 l9_200=l9_199;
float4 l9_201=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_200.xy,bias(l9_194));
float4 l9_202=l9_201;
float4 l9_203=l9_202;
l9_165=l9_203;
}
float4 l9_204=l9_165;
float3 l9_205=l9_204.xyz;
float3 l9_206=l9_205;
float3 l9_207=l9_163.xyz;
float3 l9_208=definedBlend(l9_206,l9_207,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_164=float4(l9_208.x,l9_208.y,l9_208.z,l9_164.w);
float3 l9_209=mix(l9_205,l9_164.xyz,float3(l9_163.w));
l9_164=float4(l9_209.x,l9_209.y,l9_209.z,l9_164.w);
l9_164.w=1.0;
float4 l9_210=l9_164;
param_25=l9_210;
}
else
{
if ((int(sc_Voxelization_tmp)!=0))
{
float4 l9_211=float4(in.varScreenPos.xyz,1.0);
param_25=l9_211;
}
else
{
if ((int(sc_OutputBounds_tmp)!=0))
{
float4 l9_212=gl_FragCoord;
float l9_213=fast::clamp(abs(l9_212.z),0.0,1.0);
float4 l9_214=float4(l9_213,1.0-l9_213,1.0,1.0);
param_25=l9_214;
}
else
{
float4 l9_215=param_25;
float4 l9_216=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_216=float4(mix(float3(1.0),l9_215.xyz,float3(l9_215.w)),l9_215.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_217=l9_215.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_217=fast::clamp(l9_217,0.0,1.0);
}
l9_216=float4(l9_215.xyz*l9_217,l9_217);
}
else
{
l9_216=l9_215;
...
float4 l9_222=param_28;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_222.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_222;
return out;
}
} // FRAGMENT SHADER
