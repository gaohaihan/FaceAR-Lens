...
float l9_4=min(min(clamp(borderScale,0.0,1.0),l9_3.x/2.0),l9_3.y/2.0);
...
{
l9_12=0.0+(((varPackedTex.x-0.0)*(sliceSizeLeft-0.0))/((l9_6-0.0)+1e-06));
}
else
{
l9_12=(varPackedTex.x<l9_7) ? (sliceSizeLeft+(((varPackedTex.x-l9_6)*(l9_10-sliceSizeLeft))/((l9_7-l9_6)+1e-06))) : (l9_10+(((varPackedTex.x-l9_7)*(1.0-l9_10))/((1.0-l9_7)+1e-06)));
}
float l9_13;
if (varPackedTex.y<l9_8)
{
l9_13=0.0+(((varPackedTex.y-0.0)*(sliceSizeBottom-0.0))/((l9_8-0.0)+1e-06));
}
else
{
l9_13=(varPackedTex.y<l9_9) ? (sliceSizeBottom+(((varPackedTex.y-l9_8)*(l9_11-sliceSizeBottom))/((l9_9-l9_8)+1e-06))) : (l9_11+(((varPackedTex.y-l9_9)*(1.0-l9_11))/((1.0-l9_9)+1e-06)));
}
int l9_14;
...
#endif
l9_56=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_60,sc_ScreenTextureLayout,l9_61).xy,0.0);
}
#endif
vec4 l9_62;
...
{
vec4 l9_63=l9_56;
l9_63.x=l9_56.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_62=l9_63;
}
#else
{
...
#endif
vec3 l9_64=mix(l9_62.xyz,definedBlend(l9_62.xyz,l9_39.xyz).xyz,vec3(l9_40));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_66=vec4(mix(vec3(1.0),l9_39.xyz,vec3(l9_40)),l9_40);
}
#else
{
vec4 l9_67;
...
#endif
l9_67=vec4(l9_39.xyz*l9_68,l9_68);
}
#else
{
l9_67=l9_39;
...
vec4 l9_73=outputMotionVectorsIfNeeded(varPos,max(l9_72,vec4(0.0)));
