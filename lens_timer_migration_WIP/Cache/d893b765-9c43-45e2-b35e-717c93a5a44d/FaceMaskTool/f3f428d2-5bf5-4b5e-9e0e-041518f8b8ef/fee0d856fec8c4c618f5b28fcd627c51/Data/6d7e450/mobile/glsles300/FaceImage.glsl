...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_70=sc_readFragData0_Platform();
vec4 l9_71;
...
#else
{
vec2 l9_73=sc_ScreenCoordsGlobalToView(l9_0);
int l9_74;
...
#endif
vec4 l9_83=outputMotionVectorsIfNeeded(varPos,max(l9_54,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_86=sc_ScreenCoordsGlobalToView(l9_0);
...
mediump vec4 l9_125=texture(sc_OITFilteredDepthBoundsTexture,l9_99);
