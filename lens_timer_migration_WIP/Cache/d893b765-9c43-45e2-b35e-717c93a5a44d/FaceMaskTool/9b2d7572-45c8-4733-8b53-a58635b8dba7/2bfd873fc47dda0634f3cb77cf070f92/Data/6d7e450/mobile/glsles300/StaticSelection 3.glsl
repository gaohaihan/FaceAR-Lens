...
#endif
vec2 l9_0=abs(sc_WorldAabbMin.xy-varPos.xy);
vec2 l9_1=abs(sc_WorldAabbMax.xy-varPos.xy);
bool l9_2=(float(min(l9_0.x,l9_0.y)<edgeSize)*1.0)!=0.0;
bool l9_3;
if (!l9_2)
{
l9_3=(float(min(l9_1.x,l9_1.y)<edgeSize)*1.0)!=0.0;
}
else
{
l9_3=l9_2;
