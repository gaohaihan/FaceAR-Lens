...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 89 -1
...
#endif
float l9_102=l9_51.w*l9_52;
vec4 l9_103=vec4(l9_51.x,l9_51.y,l9_51.z,vec4(0.0).w);
l9_103.w=l9_102;
...
{
l9_106=clamp(l9_102*2.0,0.0,1.0);
}
#else
{
float l9_107;
...
{
l9_107=clamp(dot(l9_103.xyz,vec3(l9_102)),0.0,1.0);
}
#else
{
float l9_108;
...
{
l9_109=(1.0-dot(l9_103.xyz,vec3(0.33333001)))*l9_102;
}
#else
{
float l9_110;
...
{
l9_110=(1.0-clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0))*l9_102;
}
#else
{
float l9_111;
...
{
l9_111=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0)*l9_102;
}
#else
{
float l9_112;
#if (sc_BlendMode_Add)
{
l9_112=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_113;
...
{
l9_114=dot(l9_103.xyz,vec3(0.33333001))*l9_102;
}
#else
{
float l9_115;
#if (sc_BlendMode_Min)
{
l9_115=1.0-clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_116;
#if (sc_BlendMode_Max)
{
l9_116=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_116=1.0;
...
#endif
l9_104=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_103.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_105);
}
#else
{
vec4 l9_117;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_120=sc_readFragData0_Platform();
vec4 l9_121;
...
{
l9_125=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_123,sc_ScreenTextureLayout,l9_124),0.0);
}
#else
{
l9_125=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_123,sc_ScreenTextureLayout,l9_124).xy,0.0);
}
#endif
l9_119=l9_125;
}
...
{
vec4 l9_127=l9_119;
l9_127.x=l9_119.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_126=l9_127;
}
#else
{
...
#endif
vec3 l9_128=mix(l9_126.xyz,definedBlend(l9_126.xyz,l9_103.xyz).xyz,vec3(l9_102));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_130=vec4(mix(vec3(1.0),l9_103.xyz,vec3(l9_102)),l9_102);
}
#else
{
vec4 l9_131;
...
#endif
l9_131=vec4(l9_103.xyz*l9_132,l9_132);
}
#else
{
l9_131=l9_103;
...
#endif
vec4 l9_133=outputMotionVectorsIfNeeded(varPos,max(l9_104,vec4(0.0)));
...
#endif
int l9_137=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_136).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_149=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_154==0)
{
l9_157=texture(sc_OITAlpha0,l9_149);
l9_156=texture(sc_OITDepthLow0,l9_149);
l9_155=texture(sc_OITDepthHigh0,l9_149);
}
else
{
l9_157=vec4(0.0);
...
if (l9_154==1)
{
l9_160=texture(sc_OITAlpha1,l9_149);
l9_159=texture(sc_OITDepthLow1,l9_149);
l9_158=texture(sc_OITDepthHigh1,l9_149);
}
else
{
l9_160=l9_157;
...
mediump vec4 l9_175=texture(sc_OITFilteredDepthBoundsTexture,l9_149);
