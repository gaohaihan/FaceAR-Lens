...
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),opacityTexLayout,l9_29);
vec4 l9_52=texture2D(opacityTex,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
l9_28=Port_Default_N204;
}
#endif
float l9_54=l9_27.w*l9_28;
vec4 l9_55=vec4(l9_27.x,l9_27.y,l9_27.z,vec4(0.0).w);
l9_55.w=l9_54;
...
{
l9_59=clamp(dot(l9_55.xyz,vec3(l9_54)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=(1.0-dot(l9_55.xyz,vec3(0.33333001)))*l9_54;
}
#else
{
float l9_62;
...
{
l9_62=(1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0))*l9_54;
}
#else
{
float l9_63;
...
{
l9_63=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*l9_54;
}
#else
{
float l9_64;
#if (sc_BlendMode_Add)
{
l9_64=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
...
{
l9_66=dot(l9_55.xyz,vec3(0.33333001))*l9_54;
}
#else
{
float l9_67;
#if (sc_BlendMode_Min)
{
l9_67=1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_68;
#if (sc_BlendMode_Max)
{
l9_68=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_68=1.0;
...
#endif
l9_56=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_55.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_57);
}
#else
{
vec4 l9_69;
...
#endif
l9_71=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_75,sc_ScreenTextureLayout,l9_76).xy,0.0);
}
#endif
vec4 l9_77;
...
{
vec4 l9_78=l9_71;
l9_78.x=l9_71.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_77=l9_78;
}
#else
{
...
#endif
vec3 l9_79=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_55.xyz).xyz,vec3(l9_54));
...
#endif
int l9_92=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_91).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_104=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_109==0)
{
l9_112=texture2D(sc_OITAlpha0,l9_104);
l9_111=texture2D(sc_OITDepthLow0,l9_104);
l9_110=texture2D(sc_OITDepthHigh0,l9_104);
}
else
{
l9_112=vec4(0.0);
...
if (l9_109==1)
{
l9_115=texture2D(sc_OITAlpha1,l9_104);
l9_114=texture2D(sc_OITDepthLow1,l9_104);
l9_113=texture2D(sc_OITDepthHigh1,l9_104);
}
else
{
l9_115=l9_112;
...
vec4 l9_130=texture2D(sc_OITFilteredDepthBoundsTexture,l9_104);
