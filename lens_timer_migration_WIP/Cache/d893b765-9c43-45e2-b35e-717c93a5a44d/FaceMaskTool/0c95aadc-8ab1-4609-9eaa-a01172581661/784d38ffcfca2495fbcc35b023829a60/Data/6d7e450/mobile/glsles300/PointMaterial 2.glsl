...
#endif
float l9_0=length(varPackedTex.xy-vec2(0.5));
float l9_1=float(l9_0<innerRadius);
bool l9_2=(float(isActive)*1.0)!=0.0;
bool l9_3;
if (l9_2)
{
l9_3=(l9_1*1.0)!=0.0;
...
bool l9_5=(float(isSelected)*1.0)!=0.0;
bool l9_6;
if (l9_5)
{
l9_6=(l9_4*1.0)!=0.0;
...
vec3 l9_10=vec3(l9_9)*baseColor.xyz;
vec4 l9_11=vec4(l9_10.x,l9_10.y,l9_10.z,vec4(0.0).w);
l9_11.w=float(l9_0<radius);
l9_7=l9_11;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_7.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_7.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_14=clamp(l9_7.w*2.0,0.0,1.0);
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_7.xyz,vec3(l9_7.w)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_7.w;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_7.w;
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_7.w;
}
#else
{
float l9_20;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_7.w;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_7.xyz,vec3(0.33333001))*l9_7.w;
}
#else
{
float l9_23;
#if (sc_BlendMode_Min)
{
l9_23=1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_24;
#if (sc_BlendMode_Max)
{
l9_24=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_24=1.0;
...
#endif
l9_12=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_7.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_13);
}
#else
{
vec4 l9_25;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_28=sc_readFragData0_Platform();
vec4 l9_29;
...
{
l9_33=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_31,sc_ScreenTextureLayout,l9_32),0.0);
}
#else
{
l9_33=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_31,sc_ScreenTextureLayout,l9_32).xy,0.0);
}
#endif
l9_27=l9_33;
}
...
#endif
vec3 l9_36=mix(l9_34.xyz,definedBlend(l9_34.xyz,l9_7.xyz).xyz,vec3(l9_7.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_38=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_7.w)),l9_7.w);
}
#else
{
vec4 l9_39;
...
#endif
l9_39=vec4(l9_7.xyz*l9_40,l9_40);
}
#else
{
l9_39=l9_7;
...
#endif
vec4 l9_41=outputMotionVectorsIfNeeded(varPos,max(l9_12,vec4(0.0)));
...
mediump vec4 l9_83=texture(sc_OITFilteredDepthBoundsTexture,l9_57);
vec2 l9_84=l9_83.xy;
int l9_85;
#if (sc_SkinBonesCount>0)
{
