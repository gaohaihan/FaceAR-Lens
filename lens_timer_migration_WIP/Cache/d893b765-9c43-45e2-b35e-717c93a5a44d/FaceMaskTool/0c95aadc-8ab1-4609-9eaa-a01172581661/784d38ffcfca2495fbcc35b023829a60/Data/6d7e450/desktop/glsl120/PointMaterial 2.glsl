...
uniform float Port_Value1_N012;
uniform float Port_Default_N012;
uniform int PreviewEnabled;
...
#endif
float l9_0=length(varPackedTex.xy-Port_Input1_N001);
...
{
l9_9=Port_Value1_N012;
}
else
{
l9_9=Port_Default_N012;
}
...
#endif
vec3 l9_35=mix(l9_33.xyz,definedBlend(l9_33.xyz,l9_7.xyz).xyz,vec3(l9_7.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_37=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_7.w)),l9_7.w);
}
#else
{
vec4 l9_38;
...
#endif
l9_38=vec4(l9_7.xyz*l9_39,l9_39);
}
#else
{
l9_38=l9_7;
