...
//spec_const bool Tweak_N139 35 0
...
//spec_const bool sc_UseFramebufferFetchMarker 73 0
...
#if (sc_FramebufferFetch)
{
vec4 l9_152=sc_readFragData0_Platform();
vec4 l9_153;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_154=l9_152;
l9_154.x=l9_152.x+_sc_framebufferFetchMarker;
l9_153=l9_154;
}
#else
{
...
#endif
l9_151=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_155,sc_ScreenTextureLayout,l9_156).xy,0.0);
}
#endif
vec4 l9_157;
...
{
vec4 l9_158=l9_151;
l9_158.x=l9_151.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_157=l9_158;
}
#else
{
...
#endif
vec3 l9_159=mix(l9_157.xyz,definedBlend(l9_157.xyz,l9_134.xyz).xyz,vec3(l9_135));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_161=vec4(mix(vec3(1.0),l9_134.xyz,vec3(l9_135)),l9_135);
}
#else
{
vec4 l9_162;
...
#endif
l9_162=vec4(l9_134.xyz*l9_163,l9_163);
}
#else
{
l9_162=l9_134;
...
{
l9_166=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_166=vec4(0.0);
...
vec4 l9_168=outputMotionVectorsIfNeeded(varPos,max(l9_167,vec4(0.0)));
vec4 l9_169=clamp(l9_168,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_170=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_170-0.0039215689)),min(1.0,l9_170+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_171=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#endif
int l9_172=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_171).xy);
float l9_173=packValue(l9_172);
int l9_180=int(l9_169.w*255.0);
float l9_181=packValue(l9_180);
sc_writeFragData0Internal(vec4(packValue(l9_172),packValue(l9_172),packValue(l9_172),packValue(l9_172)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_173,packValue(l9_172),packValue(l9_172),packValue(l9_172)));
sc_writeFragData2(vec4(l9_181,packValue(l9_180),packValue(l9_180),packValue(l9_180)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_184=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_184).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_189==0)
{
l9_192=texture2D(sc_OITAlpha0,l9_184);
l9_191=texture2D(sc_OITDepthLow0,l9_184);
l9_190=texture2D(sc_OITDepthHigh0,l9_184);
}
else
{
l9_192=vec4(0.0);
...
if (l9_189==1)
{
l9_195=texture2D(sc_OITAlpha1,l9_184);
l9_194=texture2D(sc_OITDepthLow1,l9_184);
l9_193=texture2D(sc_OITDepthHigh1,l9_184);
}
else
{
l9_195=l9_192;
...
if (any(notEqual(l9_193,vec4(0.0)))||any(notEqual(l9_194,vec4(0.0))))
{
int l9_196[8]=l9_185;
unpackValues(l9_193.w,l9_189,l9_196);
unpackValues(l9_193.z,l9_189,l9_196);
unpackValues(l9_193.y,l9_189,l9_196);
unpackValues(l9_193.x,l9_189,l9_196);
unpackValues(l9_194.w,l9_189,l9_196);
unpackValues(l9_194.z,l9_189,l9_196);
unpackValues(l9_194.y,l9_189,l9_196);
unpackValues(l9_194.x,l9_189,l9_196);
int l9_205[8]=l9_186;
unpackValues(l9_195.w,l9_189,l9_205);
unpackValues(l9_195.z,l9_189,l9_205);
unpackValues(l9_195.y,l9_189,l9_205);
unpackValues(l9_195.x,l9_189,l9_205);
}
l9_189++;
continue;
}
...
vec4 l9_210=texture2D(sc_OITFilteredDepthBoundsTexture,l9_184);
vec2 l9_211=l9_210.xy;
int l9_212;
#if (sc_SkinBonesCount>0)
{
l9_212=encodeDepth(((1.0-l9_210.x)*1000.0)+getDepthOrderingEpsilon(),l9_211);
}
#else
{
l9_212=0;
...
#endif
int l9_213=encodeDepth(viewSpaceDepth(),l9_211);
vec4 l9_214;
l9_214=l9_169*l9_169.w;
vec4 l9_215;
int l9_216=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_216<8)
{
int l9_217=l9_185[l9_216];
int l9_218=l9_213-l9_212;
bool l9_219=l9_217<l9_218;
bool l9_220;
if (l9_219)
{
l9_220=l9_185[l9_216]>0;
}
else
{
l9_220=l9_219;
...
if (l9_220)
{
vec3 l9_221=l9_214.xyz*(1.0-(float(l9_186[l9_216])/255.0));
l9_215=vec4(l9_221.x,l9_221.y,l9_221.z,l9_214.w);
}
else
{
l9_215=l9_214;
...
sc_writeFragData0Internal(l9_214,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
