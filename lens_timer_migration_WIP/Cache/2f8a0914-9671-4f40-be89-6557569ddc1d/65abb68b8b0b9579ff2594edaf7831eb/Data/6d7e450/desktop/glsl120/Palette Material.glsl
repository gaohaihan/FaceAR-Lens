...
#endif
vec3 l9_74=mix(l9_72.xyz,definedBlend(l9_72.xyz,l9_49.xyz).xyz,vec3(l9_50));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_76=vec4(mix(vec3(1.0),l9_49.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_77;
...
#endif
l9_77=vec4(l9_49.xyz*l9_78,l9_78);
}
#else
{
l9_77=l9_49;
