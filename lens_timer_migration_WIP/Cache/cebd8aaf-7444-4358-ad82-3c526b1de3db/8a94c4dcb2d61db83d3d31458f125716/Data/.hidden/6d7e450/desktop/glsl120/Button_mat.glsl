...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_button_texture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_button_texture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int button_textureLayout 83 0
...
#endif
vec3 l9_51=mix(l9_49.xyz,definedBlend(l9_49.xyz,l9_27.xyz).xyz,vec3(l9_25.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_53=vec4(mix(vec3(1.0),l9_27.xyz,vec3(l9_25.w)),l9_25.w);
}
#else
{
vec4 l9_54;
