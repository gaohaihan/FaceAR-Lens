...
//spec_const bool slider_textureHasSwappedViews 76 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_bg_texture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_slider_texture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_bg_texture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_slider_texture 82 -1
//spec_const int bg_textureLayout 83 0
...
//spec_const int slider_textureLayout 93 0
//SG_REFLECTION_END
#ifdef is_vertical
#undef is_vertical
#endif
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_82=vec4(mix(vec3(1.0),l9_61.xyz,vec3(l9_60)),l9_60);
}
#else
{
vec4 l9_83;
...
#endif
l9_83=vec4(l9_61.xyz*l9_84,l9_84);
}
#else
{
l9_83=l9_61;
