...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_button_texture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_button_texture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int button_textureLayout 77 0
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_48=vec4(mix(vec3(1.0),l9_27.xyz,vec3(l9_25.w)),l9_25.w);
}
#else
{
vec4 l9_49;
...
#endif
l9_49=vec4(l9_27.xyz*l9_50,l9_50);
}
#else
{
l9_49=l9_27;
