...
//sampler sampler button_textureSmpSC 0:16
...
//texture texture2D button_texture 0:0:0:16
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_button_texture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_button_texture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 78 -1
//spec_const int button_textureLayout 79 0
...
#endif
vec2 l9_0=((varPackedTex.xy-Port_Center_N006)*vec2((((button_size-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))+Port_Center_N006;
int l9_1;
...
#endif
bool l9_2=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_button_texture)!=0));
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,button_textureUvMinMax.x,button_textureUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_button_texture)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,button_textureUvMinMax.y,button_textureUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_button_texture)!=0),button_textureTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).x,l9_2,l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_button_texture,SC_SOFTWARE_WRAP_MODE_V_button_texture).y,l9_2,l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),button_textureLayout,l9_1);
vec4 l9_24=texture2D(button_texture,l9_23.xy,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_button_texture)
{
l9_25=mix(button_textureBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
{
l9_30=clamp(l9_25.w*2.0,0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_27.xyz,vec3(l9_25.w)),0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_33=(1.0-dot(l9_27.xyz,vec3(0.33333001)))*l9_25.w;
}
#else
{
float l9_34;
...
{
l9_34=(1.0-clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0))*l9_25.w;
}
#else
{
float l9_35;
...
{
l9_35=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_25.w;
}
#else
{
float l9_36;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_37=clamp(dot(l9_27.xyz,vec3(1.0)),0.0,1.0)*l9_25.w;
}
#else
{
float l9_38;
...
{
l9_38=dot(l9_27.xyz,vec3(0.33333001))*l9_25.w;
}
#else
{
float l9_39;
...
#if (sc_FramebufferFetch)
{
l9_43=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_43=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_44,sc_ScreenTextureLayout,l9_45).xy,0.0);
}
#endif
vec3 l9_46=mix(l9_43.xyz,definedBlend(l9_43.xyz,l9_27.xyz).xyz,vec3(l9_25.w));
...
#if (sc_Voxelization)
{
l9_48=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_49;
#if (sc_OutputBounds)
{
float l9_50=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_49=vec4(l9_50,1.0-l9_50,1.0,1.0);
}
#else
{
vec4 l9_51;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_27.xyz,vec3(l9_25.w)),l9_25.w);
}
#else
{
vec4 l9_52;
...
#endif
l9_52=vec4(l9_27.xyz*l9_53,l9_53);
}
#else
{
l9_52=l9_27;
...
vec4 l9_56=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_54,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_58-0.0039215689)),min(1.0,l9_58+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_60),packValue(l9_60),packValue(l9_60),packValue(l9_60)),sc_UniformConstants.x,sc_ShaderCacheConstant);
