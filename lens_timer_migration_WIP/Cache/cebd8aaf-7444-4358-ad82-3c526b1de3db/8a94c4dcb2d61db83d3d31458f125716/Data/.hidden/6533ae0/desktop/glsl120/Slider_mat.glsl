...
//spec_const bool slider_textureHasSwappedViews 78 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_bg_texture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_slider_texture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_bg_texture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_slider_texture 84 -1
//spec_const int bg_textureLayout 85 0
...
//spec_const int slider_textureLayout 95 0
//SG_REFLECTION_END
#ifdef is_vertical
#undef is_vertical
#endif
...
#if (sc_FramebufferFetch)
{
l9_77=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_77=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_78,sc_ScreenTextureLayout,l9_79).xy,0.0);
}
#endif
vec3 l9_80=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_61.xyz).xyz,vec3(l9_60));
...
#if (sc_Voxelization)
{
l9_82=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_83;
#if (sc_OutputBounds)
{
float l9_84=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_83=vec4(l9_84,1.0-l9_84,1.0,1.0);
}
#else
{
vec4 l9_85;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_85=vec4(mix(vec3(1.0),l9_61.xyz,vec3(l9_60)),l9_60);
}
#else
{
vec4 l9_86;
...
#endif
l9_86=vec4(l9_61.xyz*l9_87,l9_87);
}
#else
{
l9_86=l9_61;
...
vec4 l9_90=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_88,vec4(0.0)));
