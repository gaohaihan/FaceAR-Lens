...
//float3x3 button_textureTransform 4432
//float4 button_textureUvMinMax 4480
//float4 button_textureBorderColor 4496
//float button_size 4512
//float4 button_color 4528
//float Port_RangeMinA_N010 4544
//float Port_RangeMaxA_N010 4548
//float Port_RangeMinB_N010 4552
//float Port_RangeMaxB_N010 4556
//float2 Port_Center_N006 4560
//float depthRef 4568
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_button_texture 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_button_texture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int button_textureLayout 75 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_button_texture [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_button_texture [[function_constant(73)]];
...
constant int button_textureLayout [[function_constant(75)]];
...
float Output_N7=0.0;
float param_1=(*sc_set0.UserUniforms).button_size;
Output_N7=param_1;
...
int l9_6=l9_1;
int param_2=button_textureLayout_tmp;
int param_3=l9_6;
float2 param_4=CoordsOut_N6;
bool param_5=(int(SC_USE_UV_TRANSFORM_button_texture_tmp)!=0);
float3x3 param_6=(*sc_set0.UserUniforms).button_textureTransform;
int2 param_7=int2(SC_SOFTWARE_WRAP_MODE_U_button_texture_tmp,SC_SOFTWARE_WRAP_MODE_V_button_texture_tmp);
bool param_8=(int(SC_USE_UV_MIN_MAX_button_texture_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).button_textureUvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_button_texture_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).button_textureBorderColor;
float param_12=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.button_texture.sample(sc_set0.button_textureSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_10)
{
...
float4 param_13=(*sc_set0.UserUniforms).button_color;
Output_N8=param_13;
