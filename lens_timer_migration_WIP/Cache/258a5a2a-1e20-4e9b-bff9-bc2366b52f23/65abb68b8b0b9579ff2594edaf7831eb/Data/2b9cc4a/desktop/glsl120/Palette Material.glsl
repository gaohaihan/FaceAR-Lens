...
#endif
float l9_26=floor(float(paletteType));
vec4 l9_27;
if (l9_26==0.0)
{
float l9_28=(Port_Value_N040+0.001)-0.001;
float l9_29=(Port_Value_N043+0.001)-0.001;
float l9_30=mix(Port_Input0_N047,(l9_28/l9_29)*(1.0-varPackedTex.y),float(varPackedTex.y>((l9_28-l9_29)/l9_28)))*clamp(brightness,0.0,1.0);
float l9_31=l9_29/l9_28;
float l9_32=mix(Port_Input0_N050,varPackedTex.y/l9_31,float(varPackedTex.y<l9_31))*clamp(saturation,0.0,1.0);
vec4 l9_33=vec4(varPackedTex.y,l9_30,l9_32,Port_Value4_N211);
float l9_34=3.0*fract(varPackedTex.y+0.16666667);
float l9_35=2.0*fract(l9_34);
vec2 l9_36=l9_33.zz-((vec2(1.0,l9_35)-vec2(max(0.0,l9_35-1.0)))*(l9_32*clamp(l9_30,0.0,1.0)));
vec3 l9_37=vec3(l9_33.z,l9_36.x,l9_36.y);
vec3 l9_38;
if (l9_34>=1.0)
{
l9_38=l9_37.zxy;
...
l9_27=vec4(l9_39,Port_Value4_N211);
}
else
{
vec4 l9_40;
if (l9_26==1.0)
{
vec2 l9_41=Port_Import_N066-Port_Import_N064;
l9_40=mix(colorEnd,colorStart,vec4(smoothstep(Port_Input0_N072,Port_Input1_N072,clamp((dot((((((((varPackedTex.xy-vec2(Port_RangeMinA_N061))/vec2((Port_RangeMaxA_N061-Port_RangeMinA_N061)+1e-06))*(Port_RangeMaxB_N061-Port_RangeMinB_N061))+vec2(Port_RangeMinB_N061))-Port_Center_N063)*Port_Import_N062)+Port_Center_N063)-Port_Import_N064,l9_41)/dot(l9_41,l9_41))+0.001,Port_Input1_N071+0.001,Port_Input2_N071+0.001)-0.001)));
}
else
{
vec4 l9_42;
if (l9_26==2.0)
{
l9_42=mix(colorStart,colorEnd,vec4(step(value,varPackedTex.y)));
}
else
{
l9_42=Port_Default_N038;
}
l9_40=l9_42;
}
l9_27=l9_40;
...
vec4 l9_48=l9_25*l9_27;
vec4 l9_49=l9_48*baseColor;
float l9_50=l9_49.w;
...
{
l9_54=clamp(dot(l9_49.xyz,vec3(l9_50)),0.0,1.0);
}
#else
{
float l9_55;
...
{
l9_56=(1.0-dot(l9_49.xyz,vec3(0.33333001)))*l9_50;
}
#else
{
float l9_57;
...
{
l9_57=(1.0-clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0))*l9_50;
}
#else
{
float l9_58;
...
{
l9_58=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_59;
#if (sc_BlendMode_Add)
{
l9_59=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=dot(l9_49.xyz,vec3(0.33333001))*l9_50;
}
#else
{
float l9_62;
#if (sc_BlendMode_Min)
{
l9_62=1.0-clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_63;
#if (sc_BlendMode_Max)
{
l9_63=clamp(dot(l9_49.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_63=1.0;
...
#endif
l9_51=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_49.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_52);
}
#else
{
vec4 l9_64;
...
#endif
l9_66=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_67,sc_ScreenTextureLayout,l9_68).xy,0.0);
}
#endif
vec3 l9_69=mix(l9_66.xyz,definedBlend(l9_66.xyz,l9_49.xyz).xyz,vec3(l9_50));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_71=vec4(mix(vec3(1.0),l9_49.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_72;
...
#endif
l9_72=vec4(l9_49.xyz*l9_73,l9_73);
}
#else
{
l9_72=l9_49;
...
vec4 l9_76=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_74,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_78-0.0039215689)),min(1.0,l9_78+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_80),packValue(l9_80),packValue(l9_80),packValue(l9_80)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_122,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
