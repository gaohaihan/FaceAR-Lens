...
bool l9_617=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_617)
{
...
float4 l9_618=fast::max(param_10,float4(0.0));
float4 param_11=l9_618;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_675=param_12;
float4 l9_676=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_676=float4(mix(float3(1.0),l9_675.xyz,float3(l9_675.w)),l9_675.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_677=l9_675.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_677=fast::clamp(l9_677,0.0,1.0);
}
l9_676=float4(l9_675.xyz*l9_677,l9_677);
}
else
{
l9_676=l9_675;
...
float4 l9_682=param_15;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_682.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_682;
return out;
}
} // FRAGMENT SHADER
