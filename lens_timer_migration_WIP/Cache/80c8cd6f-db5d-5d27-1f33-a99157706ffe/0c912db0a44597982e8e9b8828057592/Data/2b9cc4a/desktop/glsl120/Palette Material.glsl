...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int baseTexLayout 77 0
...
//spec_const int sc_StereoViewID 86 0
//SG_REFLECTION_END
#ifdef isVertical
#undef isVertical
#endif
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_97=vec4(mix(vec3(1.0),l9_71.xyz,vec3(l9_70)),l9_70);
}
#else
{
vec4 l9_98;
...
#endif
l9_98=vec4(l9_71.xyz*l9_99,l9_99);
}
#else
{
l9_98=l9_71;
