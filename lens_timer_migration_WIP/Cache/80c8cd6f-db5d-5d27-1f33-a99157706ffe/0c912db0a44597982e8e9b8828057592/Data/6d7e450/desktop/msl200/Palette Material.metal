...
param_19=l9_219;
float l9_220=param_19.x;
int l9_221=param_22.x;
bool l9_222=l9_184;
float l9_223=l9_185;
...
param_19.x=l9_220;
l9_185=l9_223;
float l9_231=param_19.y;
int l9_232=param_22.y;
bool l9_233=l9_184;
float l9_234=l9_185;
...
param_19.y=l9_231;
l9_185=l9_234;
float2 l9_242=param_19;
int l9_243=param_17;
int l9_244=param_18;
float l9_245=param_27;
...
float l9_253=l9_245;
float4 l9_254=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_252,bias(l9_253));
float4 l9_255=l9_254;
float4 l9_256=l9_255;
if (param_25)
{
l9_256=mix(param_26,l9_256,float4(l9_185));
}
...
bool l9_258=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_259;
if (l9_258)
{
l9_259=!PreviewInfo.Saved;
}
else
{
l9_259=l9_258;
...
if (l9_259)
{
l9_260=51==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_260=l9_259;
...
bool l9_264=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_264)
{
...
float4 l9_265=fast::max(param_31,float4(0.0));
float4 param_32=l9_265;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_269=l9_268;
float l9_270=l9_269;
float l9_271=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_270;
float3 l9_272=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_266.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_278.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_281=l9_280.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_318=l9_310;
float4 l9_319=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_317,bias(l9_318));
...
float3 l9_329=definedBlend(l9_327,l9_328,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_337=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_337=float4(0.0);
