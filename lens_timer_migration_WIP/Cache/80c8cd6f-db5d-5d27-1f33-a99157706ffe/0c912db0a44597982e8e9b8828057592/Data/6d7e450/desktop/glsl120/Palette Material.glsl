...
#endif
vec3 l9_100=mix(l9_98.xyz,definedBlend(l9_98.xyz,l9_71.xyz).xyz,vec3(l9_70));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_102=vec4(mix(vec3(1.0),l9_71.xyz,vec3(l9_70)),l9_70);
}
#else
{
vec4 l9_103;
...
#endif
l9_103=vec4(l9_71.xyz*l9_104,l9_104);
}
#else
{
l9_103=l9_71;
