...
ssGlobals l9_1=ssGlobals(sc_Time.x,sc_Time.y,0.0,varPackedTex.xy);
float l9_2=floor(float(paletteType));
vec4 l9_3;
if (l9_2==0.0)
{
float l9_4;
Node1_If_else(0.0,0.0,0.0,l9_4,l9_1);
float l9_5=l9_4;
float l9_6=(Port_Value_N040+0.001)-0.001;
float l9_7=(Port_Value_N043+0.001)-0.001;
float l9_8=mix(Port_Input0_N047,(l9_6/l9_7)*(1.0-l9_5),float(l9_5>((l9_6-l9_7)/l9_6)))*clamp(brightness,0.0,1.0);
float l9_9=l9_7/l9_6;
float l9_10=mix(Port_Input0_N050,l9_5/l9_9,float(l9_5<l9_9))*clamp(saturation,0.0,1.0);
vec4 l9_11=vec4(l9_5,l9_8,l9_10,Port_Value4_N211);
float l9_12=3.0*fract(l9_5+0.16666667);
float l9_13=2.0*fract(l9_12);
vec2 l9_14=l9_11.zz-((vec2(1.0,l9_13)-vec2(max(0.0,l9_13-1.0)))*(l9_10*clamp(l9_8,0.0,1.0)));
vec3 l9_15=vec3(l9_11.z,l9_14.x,l9_14.y);
vec3 l9_16;
if (l9_12>=1.0)
{
l9_16=l9_15.zxy;
...
l9_3=vec4(l9_17,Port_Value4_N211);
}
else
{
vec4 l9_18;
...
{
l9_19=Port_Value1_N024;
}
else
{
l9_19=Port_Default_N024;
}
float l9_20=radians(l9_19);
float l9_21=sin(l9_20);
float l9_22=cos(l9_20);
vec2 l9_23=((Port_Value_N017+vec2(0.001))-vec2(0.001))-Port_Center_N022;
vec2 l9_24=vec2(l9_22,l9_21);
vec2 l9_25=vec2(-l9_21,l9_22);
vec2 l9_26=vec2(dot(l9_24,l9_23),dot(l9_25,l9_23))+Port_Center_N022;
vec2 l9_27=((Port_Value_N019+vec2(0.001))-vec2(0.001))-Port_Center_N023;
vec2 l9_28=(vec2(dot(l9_24,l9_27),dot(l9_25,l9_27))+Port_Center_N023)-l9_26;
l9_18=mix(colorEnd,colorStart,vec4(smoothstep(Port_Input0_N072,Port_Input1_N072,clamp((dot((((((((varPackedTex.xy-vec2(Port_RangeMinA_N061))/vec2((Port_RangeMaxA_N061-Port_RangeMinA_N061)+1e-06))*(Port_RangeMaxB_N061-Port_RangeMinB_N061))+vec2(Port_RangeMinB_N061))-Port_Center_N063)*Port_Import_N062)+Port_Center_N063)-l9_26,l9_28)/dot(l9_28,l9_28))+0.001,Port_Input1_N071+0.001,Port_Input2_N071+0.001)-0.001)));
}
else
{
vec4 l9_29;
...
{
float l9_30;
Node1_If_else(0.0,0.0,0.0,l9_30,l9_1);
l9_29=mix(colorStart,colorEnd,vec4(step(value,l9_30)));
}
else
{
l9_29=Port_Default_N038;
}
l9_18=l9_29;
}
l9_3=l9_18;
}
vec2 l9_31=vec2(length(sc_ModelMatrix[0].xyz),length(sc_ModelMatrix[1].xyz));
bool l9_32=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w+0.00050000002)>0.0;
bool l9_33;
if (l9_32)
{
l9_33=(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].w-0.00050000002)<0.0;
}
else
{
l9_33=l9_32;
...
if (!l9_33)
{
l9_34=l9_31*(abs(vec2(0.0,sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][1].y)).y/0.1);
}
else
{
l9_34=l9_31;
}
float l9_35=min(min(clamp(borderScale,0.0,1.0),l9_34.x/2.0),l9_34.y/2.0);
float l9_36=(baseTexSize.x/baseTexSize.y)*l9_35;
float l9_37=((Port_Import_N032*l9_36)*2.0)/l9_34.x;
float l9_38=1.0-(((Port_Import_N035*l9_36)*2.0)/l9_34.x);
float l9_39=((Port_Import_N036*l9_35)*2.0)/l9_34.y;
float l9_40=1.0-(((Port_Import_N033*l9_35)*2.0)/l9_34.y);
float l9_41=1.0-Port_Import_N035;
float l9_42=1.0-Port_Import_N033;
float l9_43;
if (varPackedTex.x<l9_37)
{
l9_43=0.0+(((varPackedTex.x-0.0)*(Port_Import_N032-0.0))/((l9_37-0.0)+1e-06));
}
else
{
l9_43=(varPackedTex.x<l9_38) ? (Port_Import_N032+(((varPackedTex.x-l9_37)*(l9_41-Port_Import_N032))/((l9_38-l9_37)+1e-06))) : (l9_41+(((varPackedTex.x-l9_38)*(1.0-l9_41))/((1.0-l9_38)+1e-06)));
}
float l9_44;
if (varPackedTex.y<l9_39)
{
l9_44=0.0+(((varPackedTex.y-0.0)*(Port_Import_N036-0.0))/((l9_39-0.0)+1e-06));
}
else
{
l9_44=(varPackedTex.y<l9_40) ? (Port_Import_N036+(((varPackedTex.y-l9_39)*(l9_42-Port_Import_N036))/((l9_40-l9_39)+1e-06))) : (l9_42+(((varPackedTex.y-l9_40)*(1.0-l9_42))/((1.0-l9_40)+1e-06)));
}
int l9_45;
...
float l9_66=l9_65;
vec3 l9_67=sc_SamplingCoordsViewToGlobal(vec2(l9_62,l9_64),baseTexLayout,l9_45);
vec4 l9_68=texture2D(baseTex,l9_67.xy,0.0);
vec4 l9_69;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
float l9_70=l9_69.w*l9_3.w;
vec4 l9_71=vec4(l9_3.xyz,l9_70);
...
{
if (l9_70<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_80=clamp(dot(l9_71.xyz,vec3(l9_70)),0.0,1.0);
}
#else
{
float l9_81;
...
{
l9_82=(1.0-dot(l9_71.xyz,vec3(0.33333001)))*l9_70;
}
#else
{
float l9_83;
...
{
l9_83=(1.0-clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0))*l9_70;
}
#else
{
float l9_84;
...
{
l9_84=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0)*l9_70;
}
#else
{
float l9_85;
#if (sc_BlendMode_Add)
{
l9_85=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_86;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_86=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0)*l9_70;
}
#else
{
float l9_87;
...
{
l9_87=dot(l9_71.xyz,vec3(0.33333001))*l9_70;
}
#else
{
float l9_88;
#if (sc_BlendMode_Min)
{
l9_88=1.0-clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_89;
#if (sc_BlendMode_Max)
{
l9_89=clamp(dot(l9_71.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_89=1.0;
...
#endif
l9_77=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_71.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_78);
}
#else
{
vec4 l9_90;
...
#if (sc_FramebufferFetch)
{
l9_92=sc_readFragData0_Platform();
}
#else
{
...
#endif
l9_92=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_93,sc_ScreenTextureLayout,l9_94).xy,0.0);
}
#endif
vec3 l9_95=mix(l9_92.xyz,definedBlend(l9_92.xyz,l9_71.xyz).xyz,vec3(l9_70));
...
#if (sc_Voxelization)
{
l9_97=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_98;
#if (sc_OutputBounds)
{
float l9_99=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_98=vec4(l9_99,1.0-l9_99,1.0,1.0);
}
#else
{
vec4 l9_100;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_100=vec4(mix(vec3(1.0),l9_71.xyz,vec3(l9_70)),l9_70);
}
#else
{
vec4 l9_101;
...
#endif
l9_101=vec4(l9_71.xyz*l9_102,l9_102);
}
#else
{
l9_101=l9_71;
...
vec4 l9_105=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_103,vec4(0.0)));
vec4 l9_106=clamp(l9_105,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_107=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_107-0.0039215689)),min(1.0,l9_107+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_108).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_109=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_108).xy);
float l9_110=packValue(l9_109);
int l9_117=int(l9_106.w*255.0);
float l9_118=packValue(l9_117);
sc_writeFragData0Internal(vec4(packValue(l9_109),packValue(l9_109),packValue(l9_109),packValue(l9_109)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_110,packValue(l9_109),packValue(l9_109),packValue(l9_109)));
sc_writeFragData2(vec4(l9_118,packValue(l9_117),packValue(l9_117),packValue(l9_117)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_121=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_121).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_126==0)
{
l9_129=texture2D(sc_OITAlpha0,l9_121);
l9_128=texture2D(sc_OITDepthLow0,l9_121);
l9_127=texture2D(sc_OITDepthHigh0,l9_121);
}
else
{
l9_129=vec4(0.0);
...
if (l9_126==1)
{
l9_132=texture2D(sc_OITAlpha1,l9_121);
l9_131=texture2D(sc_OITDepthLow1,l9_121);
l9_130=texture2D(sc_OITDepthHigh1,l9_121);
}
else
{
l9_132=l9_129;
...
if (any(notEqual(l9_130,vec4(0.0)))||any(notEqual(l9_131,vec4(0.0))))
{
int l9_133[8]=l9_122;
unpackValues(l9_130.w,l9_126,l9_133);
unpackValues(l9_130.z,l9_126,l9_133);
unpackValues(l9_130.y,l9_126,l9_133);
unpackValues(l9_130.x,l9_126,l9_133);
unpackValues(l9_131.w,l9_126,l9_133);
unpackValues(l9_131.z,l9_126,l9_133);
unpackValues(l9_131.y,l9_126,l9_133);
unpackValues(l9_131.x,l9_126,l9_133);
int l9_142[8]=l9_123;
unpackValues(l9_132.w,l9_126,l9_142);
unpackValues(l9_132.z,l9_126,l9_142);
unpackValues(l9_132.y,l9_126,l9_142);
unpackValues(l9_132.x,l9_126,l9_142);
}
l9_126++;
continue;
}
...
vec4 l9_147=texture2D(sc_OITFilteredDepthBoundsTexture,l9_121);
vec2 l9_148=l9_147.xy;
int l9_149;
#if (sc_SkinBonesCount>0)
{
l9_149=encodeDepth(((1.0-l9_147.x)*1000.0)+getDepthOrderingEpsilon(),l9_148);
}
#else
{
l9_149=0;
...
#endif
int l9_150=encodeDepth(viewSpaceDepth(),l9_148);
vec4 l9_151;
l9_151=l9_106*l9_106.w;
vec4 l9_152;
int l9_153=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_153<8)
{
int l9_154=l9_122[l9_153];
int l9_155=l9_150-l9_149;
bool l9_156=l9_154<l9_155;
bool l9_157;
if (l9_156)
{
l9_157=l9_122[l9_153]>0;
}
else
{
l9_157=l9_156;
...
if (l9_157)
{
vec3 l9_158=l9_151.xyz*(1.0-(float(l9_123[l9_153])/255.0));
l9_152=vec4(l9_158.x,l9_158.y,l9_158.z,l9_151.w);
}
else
{
l9_152=l9_151;
