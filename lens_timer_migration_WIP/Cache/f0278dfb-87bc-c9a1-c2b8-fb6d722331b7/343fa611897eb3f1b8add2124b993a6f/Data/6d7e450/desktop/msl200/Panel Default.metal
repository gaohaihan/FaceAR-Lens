...
//}
//ubo int UserUniforms 0:33:4496 {
//float4 sc_Time 1376
...
//float4 baseTexSize 4272
//float3x3 baseTexTransform 4320
//float4 baseTexUvMinMax 4368
//float4 baseTexBorderColor 4384
//float borderScale 4400
//float sliceSizeLeft 4404
//float sliceSizeRight 4408
//float sliceSizeTop 4412
//float sliceSizeBottom 4416
...
float2 param_6=Value_N25;
float param_7=Value_N17;
float param_8=Value_N11;
float param_9=Value_N35;
float param_10=Value_N28;
float param_11=Value_N38;
float2 param_12=Value_N82;
...
float4x4 l9_5=(*sc_set0.UserUniforms).sc_ModelMatrix;
float l9_6=length(l9_5[0].xyz);
float4x4 l9_7=(*sc_set0.UserUniforms).sc_ModelMatrix;
float l9_8=length(l9_7[1].xyz);
float2 l9_9=float2(l9_6,l9_8);
int l9_10=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_10=0;
...
int l9_11=l9_10;
float4x4 l9_12=(*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_11];
float l9_13=l9_12[3].w;
float l9_14=0.0;
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17=(l9_15+0.00050000002)>l9_16;
bool l9_18;
if (l9_17)
{
l9_18=(l9_13-0.00050000002)<l9_14;
}
else
{
l9_18=l9_17;
...
int l9_22=l9_21;
float4x4 l9_23=(*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_22];
int l9_24=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_24=0;
...
int l9_25=l9_24;
float4x4 l9_26=(*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_25];
float2 l9_27=abs(float2(l9_23[0].x,l9_26[1].y));
float l9_28=l9_27.y/0.1;
l9_9*=l9_28;
}
float l9_29=N2_MaxBorderSize;
float2 l9_30=l9_9;
float l9_31=fast::min(fast::min(l9_29,l9_30.x/2.0),l9_30.y/2.0);
float l9_32=l9_31;
float2 l9_33=N2_TextureSize;
float l9_34=l9_32;
float2 l9_35=float2((l9_33.x/l9_33.y)*l9_34,l9_34);
float2 l9_36=l9_35;
float l9_37=((N2_SliceLeft*l9_36.x)*2.0)/l9_9.x;
float l9_38=1.0-(((N2_SliceRight*l9_36.x)*2.0)/l9_9.x);
float l9_39=((N2_SliceBottom*l9_36.y)*2.0)/l9_9.y;
float l9_40=1.0-(((N2_SliceTop*l9_36.y)*2.0)/l9_9.y);
float l9_41=0.0+(((N2_UV.x-0.0)*(N2_SliceLeft-0.0))/((l9_37-0.0)+1e-06));
float l9_42=N2_SliceLeft+(((N2_UV.x-l9_37)*((1.0-N2_SliceRight)-N2_SliceLeft))/((l9_38-l9_37)+1e-06));
float l9_43=(1.0-N2_SliceRight)+(((N2_UV.x-l9_38)*(1.0-(1.0-N2_SliceRight)))/((1.0-l9_38)+1e-06));
float l9_44=0.0+(((N2_UV.y-0.0)*(N2_SliceBottom-0.0))/((l9_39-0.0)+1e-06));
float l9_45=N2_SliceBottom+(((N2_UV.y-l9_39)*((1.0-N2_SliceTop)-N2_SliceBottom))/((l9_40-l9_39)+1e-06));
float l9_46=(1.0-N2_SliceTop)+(((N2_UV.y-l9_40)*(1.0-(1.0-N2_SliceTop)))/((1.0-l9_40)+1e-06));
float l9_47;
if (N2_UV.x<l9_37)
{
l9_47=l9_41;
...
{
l9_47=(N2_UV.x<l9_38) ? l9_42 : l9_43;
}
float l9_48=l9_47;
float l9_49;
if (N2_UV.y<l9_39)
...
{
l9_49=(N2_UV.y<l9_40) ? l9_45 : l9_46;
}
float l9_50=l9_49;
N2_Result=float2(l9_48,l9_50);
param_13=N2_Result;
Result_N2=param_13;
...
float param_24=0.0;
bool l9_57=param_22&&(!param_20);
float l9_58=1.0;
float l9_59=param_16.x;
int l9_60=param_19.x;
if (l9_60==1)
{
l9_59=fract(l9_59);
}
...
param_16.x=l9_59;
float l9_64=param_16.y;
int l9_65=param_19.y;
if (l9_65==1)
{
l9_64=fract(l9_64);
}
...
float l9_71=param_16.x;
float l9_72=param_21.x;
float l9_73=param_21.z;
bool l9_74=l9_70;
float l9_75=l9_58;
...
float l9_80=param_16.y;
float l9_81=param_21.y;
float l9_82=param_21.w;
bool l9_83=l9_79;
float l9_84=l9_58;
...
float2 l9_87=param_16;
bool l9_88=param_17;
float3x3 l9_89=param_18;
if (l9_88)
{
...
float2 l9_92=l9_91;
param_16=l9_92;
float l9_93=param_16.x;
int l9_94=param_19.x;
bool l9_95=l9_57;
float l9_96=l9_58;
if ((l9_94==0)||(l9_94==3))
{
...
param_16.x=l9_93;
l9_58=l9_96;
float l9_104=param_16.y;
int l9_105=param_19.y;
bool l9_106=l9_57;
float l9_107=l9_58;
...
param_16.y=l9_104;
l9_58=l9_107;
float2 l9_115=param_16;
int l9_116=param_14;
int l9_117=param_15;
float l9_118=param_24;
...
float2 l9_125=l9_124.xy;
float l9_126=l9_118;
float4 l9_127=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_125,bias(l9_126));
float4 l9_128=l9_127;
float4 l9_129=l9_128;
if (param_22)
{
l9_129=mix(param_23,l9_129,float4(l9_58));
}
float4 l9_130=l9_129;
Color_N0=l9_130;
float4 Output_N12=float4(0.0);
float4 param_25=(*sc_set0.UserUniforms).baseColor;
Output_N12=param_25;
...
float2 l9_132=floor(mod(l9_131.xy,float2(4.0)));
float l9_133=(mod(dot(l9_132,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_26<l9_133)
{
discard_fragment();
}
}
bool l9_134=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_134)
{
...
float4 l9_135=fast::max(param_27,float4(0.0));
float4 param_28=l9_135;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_138=fast::clamp(l9_137.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_138=fast::clamp(dot(l9_137.xyz,float3(l9_137.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_138=(1.0-dot(l9_137.xyz,float3(0.33333001)))*l9_137.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_138=(1.0-fast::clamp(dot(l9_137.xyz,float3(1.0)),0.0,1.0))*l9_137.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_138=fast::clamp(dot(l9_137.xyz,float3(1.0)),0.0,1.0)*l9_137.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_138=fast::clamp(dot(l9_137.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_138=dot(l9_137.xyz,float3(0.33333001))*l9_137.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_138=1.0-fast::clamp(dot(l9_137.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_139=l9_138;
float l9_140=l9_139;
float l9_141=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_140;
float3 l9_142=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_136.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_143=float4(l9_142.x,l9_142.y,l9_142.z,l9_141);
param_29=l9_143;
}
else
{
...
{
float4 l9_144=param_29;
float4 l9_145=float4(0.0);
float4 l9_146=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_147=out.FragColor0;
float4 l9_148=l9_147;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_148.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
int l9_178=sc_ScreenTextureLayout_tmp;
int l9_179=l9_174;
float l9_180=l9_175;
...
float l9_188=l9_180;
float4 l9_189=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_187,bias(l9_188));
float4 l9_190=l9_189;
l9_176=l9_190;
float4 l9_191=l9_176;
float4 l9_192=l9_191;
float4 l9_193=l9_192;
l9_146=l9_193;
}
float4 l9_194=l9_146;
float4 l9_195=l9_194;
float3 l9_196=l9_195.xyz;
float3 l9_197=l9_196;
float3 l9_198=l9_144.xyz;
float3 l9_199=definedBlend(l9_197,l9_198,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_145=float4(l9_199.x,l9_199.y,l9_199.z,l9_145.w);
float3 l9_200=mix(l9_196,l9_145.xyz,float3(l9_144.w));
l9_145=float4(l9_200.x,l9_200.y,l9_200.z,l9_145.w);
l9_145.w=1.0;
float4 l9_201=l9_145;
param_29=l9_201;
}
else
{
float4 l9_202=param_29;
float4 l9_203=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_203=float4(mix(float3(1.0),l9_202.xyz,float3(l9_202.w)),l9_202.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_204=l9_202.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_204=fast::clamp(l9_204,0.0,1.0);
}
l9_203=float4(l9_202.xyz*l9_204,l9_204);
}
else
{
l9_203=l9_202;
...
float4 l9_205=l9_203;
param_29=l9_205;
}
}
}
float4 l9_206=param_29;
FinalColor=l9_206;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_207=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_207=float4(0.0);
...
float4 l9_209=param_32;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_209.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_209;
return out;
}
} // FRAGMENT SHADER
