...
#endif
vec3 l9_76=mix(l9_74.xyz,definedBlend(l9_74.xyz,l9_52.xyz).xyz,vec3(l9_26));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_78=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_26)),l9_26);
}
#else
{
vec4 l9_79;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_87-0.0039215689)),min(1.0,l9_87+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_89),packValue(l9_89),packValue(l9_89),packValue(l9_89)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_131,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
