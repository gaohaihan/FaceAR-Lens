...
//float3x3 opacityTexTransform 4464
//float4 opacityTexUvMinMax 4512
//float4 opacityTexBorderColor 4528
//float depthRef 4544
//}
...
//spec_const bool sc_ProxyAlphaOne 69 0
...
{
float4 l9_6=N0_baseColor;
float2 l9_7=tempGlobals.Surface_UVCoord0;
float2 l9_8=l9_7;
...
int l9_15=l9_10;
int l9_16=baseTexLayout_tmp;
int l9_17=l9_15;
float2 l9_18=l9_8;
bool l9_19=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 l9_20=(*sc_set0.UserUniforms).baseTexTransform;
int2 l9_21=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool l9_22=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 l9_23=(*sc_set0.UserUniforms).baseTexUvMinMax;
bool l9_24=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 l9_25=(*sc_set0.UserUniforms).baseTexBorderColor;
float l9_26=0.0;
bool l9_27=l9_24&&(!l9_22);
float l9_28=1.0;
float l9_29=l9_18.x;
int l9_30=l9_21.x;
if (l9_30==1)
...
float l9_96=l9_88;
float4 l9_97=sc_set0.baseTex.sample(sc_set0.baseTexSmpSC,l9_95,bias(l9_96));
float4 l9_98=l9_97;
float4 l9_99=l9_98;
if (l9_24)
{
l9_99=mix(l9_25,l9_99,float4(l9_28));
}
float4 l9_100=l9_99;
l9_9=l9_100;
float4 l9_101=l9_9;
...
{
float l9_104=l9_102.w;
float2 l9_105=tempGlobals.Surface_UVCoord1;
...
int l9_113=l9_108;
int l9_114=opacityTexLayout_tmp;
int l9_115=l9_113;
float2 l9_116=l9_106;
bool l9_117=(int(SC_USE_UV_TRANSFORM_opacityTex_tmp)!=0);
float3x3 l9_118=(*sc_set0.UserUniforms).opacityTexTransform;
int2 l9_119=int2(SC_SOFTWARE_WRAP_MODE_U_opacityTex_tmp,SC_SOFTWARE_WRAP_MODE_V_opacityTex_tmp);
bool l9_120=(int(SC_USE_UV_MIN_MAX_opacityTex_tmp)!=0);
float4 l9_121=(*sc_set0.UserUniforms).opacityTexUvMinMax;
bool l9_122=(int(SC_USE_CLAMP_TO_BORDER_opacityTex_tmp)!=0);
float4 l9_123=(*sc_set0.UserUniforms).opacityTexBorderColor;
float l9_124=0.0;
bool l9_125=l9_122&&(!l9_120);
float l9_126=1.0;
float l9_127=l9_116.x;
int l9_128=l9_119.x;
if (l9_128==1)
{
l9_127=fract(l9_127);
...
float l9_139=l9_116.x;
float l9_140=l9_121.x;
float l9_141=l9_121.z;
bool l9_142=l9_138;
float l9_143=l9_126;
...
float l9_148=l9_116.y;
float l9_149=l9_121.y;
float l9_150=l9_121.w;
bool l9_151=l9_147;
float l9_152=l9_126;
...
float2 l9_155=l9_116;
bool l9_156=l9_117;
float3x3 l9_157=l9_118;
if (l9_156)
{
...
float3 l9_192=l9_191;
float2 l9_193=l9_192.xy;
float l9_194=l9_186;
float4 l9_195=sc_set0.opacityTex.sample(sc_set0.opacityTexSmpSC,l9_193,bias(l9_194));
float4 l9_196=l9_195;
float4 l9_197=l9_196;
if (l9_122)
{
l9_197=mix(l9_123,l9_197,float4(l9_126));
}
float4 l9_198=l9_197;
l9_107=l9_198;
float4 l9_199=l9_107;
l9_103=l9_104*l9_199.x;
}
else
{
l9_103=l9_102.w;
...
float l9_200=l9_103;
N0_Result=float4(l9_102.xyz,l9_200);
param_2=N0_Result;
Result_N0=param_2;
...
bool l9_204=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_204)
{
...
float4 l9_205=fast::max(param_5,float4(0.0));
float4 param_6=l9_205;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_208=fast::clamp(l9_207.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_208=fast::clamp(dot(l9_207.xyz,float3(l9_207.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_208=(1.0-dot(l9_207.xyz,float3(0.33333001)))*l9_207.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_208=(1.0-fast::clamp(dot(l9_207.xyz,float3(1.0)),0.0,1.0))*l9_207.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_208=fast::clamp(dot(l9_207.xyz,float3(1.0)),0.0,1.0)*l9_207.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_208=fast::clamp(dot(l9_207.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_208=dot(l9_207.xyz,float3(0.33333001))*l9_207.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_208=1.0-fast::clamp(dot(l9_207.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_209=l9_208;
float l9_210=l9_209;
float l9_211=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_210;
float3 l9_212=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_206.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_213=float4(l9_212.x,l9_212.y,l9_212.z,l9_211);
param_7=l9_213;
}
else
{
...
{
float4 l9_214=param_7;
float4 l9_215=float4(0.0);
float4 l9_216=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_217=out.FragColor0;
float4 l9_218=l9_217;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_218.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_220=gl_FragCoord;
float2 l9_221=l9_220.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_226=l9_225;
int l9_227=l9_226;
float3 l9_228=float3(l9_222,0.0);
int l9_229=l9_224;
int l9_230=l9_227;
if (l9_229==1)
{
l9_228.y=((2.0*l9_228.y)+float(l9_230))-1.0;
}
float2 l9_231=l9_228.xy;
l9_223=l9_231;
}
else
{
...
int l9_248=sc_ScreenTextureLayout_tmp;
int l9_249=l9_244;
float l9_250=l9_245;
...
if (l9_252==0)
{
l9_254=float3(l9_251,0.0);
}
else
{
if (l9_252==1)
{
l9_254=float3(l9_251.x,(l9_251.y*0.5)+(0.5-(float(l9_253)*0.5)),0.0);
}
else
{
l9_254=float3(l9_251,float(l9_253));
}
}
float3 l9_255=l9_254;
float3 l9_256=l9_255;
float2 l9_257=l9_256.xy;
float l9_258=l9_250;
float4 l9_259=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_257,bias(l9_258));
float4 l9_260=l9_259;
l9_246=l9_260;
float4 l9_261=l9_246;
float4 l9_262=l9_261;
float4 l9_263=l9_262;
l9_216=l9_263;
}
float4 l9_264=l9_216;
float4 l9_265=l9_264;
float3 l9_266=l9_265.xyz;
float3 l9_267=l9_266;
float3 l9_268=l9_214.xyz;
float3 l9_269=definedBlend(l9_267,l9_268,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_215=float4(l9_269.x,l9_269.y,l9_269.z,l9_215.w);
float3 l9_270=mix(l9_266,l9_215.xyz,float3(l9_214.w));
l9_215=float4(l9_270.x,l9_270.y,l9_270.z,l9_215.w);
l9_215.w=1.0;
float4 l9_271=l9_215;
param_7=l9_271;
}
else
{
float4 l9_272=param_7;
float4 l9_273=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_273=float4(mix(float3(1.0),l9_272.xyz,float3(l9_272.w)),l9_272.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_274=l9_272.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_274=fast::clamp(l9_274,0.0,1.0);
}
l9_273=float4(l9_272.xyz*l9_274,l9_274);
}
else
{
l9_273=l9_272;
...
{
l9_277=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_277=float4(0.0);
...
float4 l9_279=param_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_279.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_279;
return out;
}
} // FRAGMENT SHADER
