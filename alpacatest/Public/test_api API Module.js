 ...
 * // Instead, you should modify the "test_api API" script and access the functions through the imported class wrapper.
*/

/*
 * @param {RemoteApiResponse} response A raw API response from an test_api API
...
ApiModule.prototype.facearendpoint1 = function(test, cb) {
    var req = global.RemoteApiRequest.create();
    req.endpoint = "facearendpoint1";
    var parameters = {};
    setParameter("test", test, parameters, true);
